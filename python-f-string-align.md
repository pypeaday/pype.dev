...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Python-F-String-Align</title>\n<meta
    ...
    | Nic Payne\" />\n<meta property=\"og:description\" content=\"I am personally
    trying to use `logger` instead of `print` in all of my code, \nhowever I learned
    from [@Python-Hub] that you can align printouts using `print` wi\" />\n<meta property=\"og:image\"
    content=\"media/python-f-string-align.png\" />\n<meta property=\"og:url\" content=\"https://pype.devpython-f-string-align\"
    ...
    my code, \nhowever I learned from [@Python-Hub] that you can align printouts using
    `print` wi\" />\n<meta name=\"twitter:image\" content=\"media/python-f-string-align.png\"
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    mt-8\">\n        <p>I am personally trying to use <code>logger</code> instead
    of <code>print</code> in all of my code,\nhowever I learned from [@Python-Hub]
