...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Python-F-String-Align</title>\n<meta
    ...
    src=\"/media/python-f-string-align.png\" alt=\"Python-F-String-Align cover image\"
    ...
    lg:prose-xl mx-auto mt-8\">\n        <p>I am personally trying to use <code>logger</code>
    instead of <code>print</code> in all of my code,\nhowever I learned from [@Python-Hub]
    that you can align printouts using <code>print</code> with <code>f</code>-strings!.</p>\n<p>This
    little python script shows how options in the <code>f</code>-string can format
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Python-F-String-Align</title>\n<meta
    ...
    font-bold text-text-heading mb-4\">Python-F-String-Align</h1>\n    <div class=\"flex
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n    <div class=\"mt-8 mb-8
    md:-mx-4\">\n        <img src=\"/media/python-f-string-align.png\" alt=\"Python-F-String-Align
