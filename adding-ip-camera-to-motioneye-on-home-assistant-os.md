---
content: '1. Dropdown menue in upper left - doesn''t look like one but just click
  the name of the current device.

  2. URL will be `rtsp://<ip address>` <- this was the ticket for me'
date: 2022-06-26
description: 'Dropdown menue in upper left - doesn&#x27;t look like one but just click
  the name of the current device. URL will be `rtsp://&lt;ip address&gt;` &lt;- this
  was '
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Adding IP Camera
    to motionEye on Home Assistant OS</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\"
    content=\"width=device-width, initial-scale=1\" />\n<meta name=\"description\"
    content=\"Dropdown menue in upper left - doesn&#x27;t look like one but just click
    the name of the current device. URL will be `rtsp://&lt;ip address&gt;` &lt;-
    ...
    IP Camera to motionEye on Home Assistant OS</h1>\n    <div class=\"flex items-center
    ...
    transition-colors border border-accent-cool/20\">\n                #tech\n            </a>\n
    \           <a href=\"https://pype.dev//tags/cameras/\" class=\"inline-block bg-primary-light
    text-accent-cool text-xs font-medium px-3 py-1 rounded-full hover:bg-primary-light/80
    transition-colors border border-accent-cool/20\">\n                #cameras\n
    ...
    lg:prose-xl mx-auto mt-8\">\n        <ol>\n<li>Dropdown menue in upper left -
    doesn't look like one but just click the name of the current device.</li>\n<li>URL
    will be <code>rtsp://&lt;ip address&gt;</code> &lt;- this was the ticket for me</li>\n</ol>\n\n
    \   </section>\n</article>        </div>\n    </main>\n\n</div>\n     </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Adding IP Camera to
    motionEye on Home Assistant OS</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\"
    content=\"width=device-width, initial-scale=1\" />\n<meta name=\"description\"
    content=\"Dropdown menue in upper left - doesn&#x27;t look like one but just click
    the name of the current device. URL will be `rtsp://&lt;ip address&gt;` &lt;-
    this was \" />\n <link href=\"/favicon.ico\" rel=\"icon\" type=\"image/png\" />\n<link
    ...
    font-bold text-text-heading mb-4\">Adding IP Camera to motionEye on Home Assistant
    ...
    class=\"inline-block bg-primary-light text-accent-cool text-xs font-medium px-3
    py-1 rounded-full hover:bg-primary-light/80 transition-colors border border-accent-cool/20\">\n
    \               #tech\n            </a>\n            <a href=\"https://pype.dev//tags/cameras/\"
    class=\"inline-block bg-primary-light text-accent-cool text-xs font-medium px-3
    py-1 rounded-full hover:bg-primary-light/80 transition-colors border border-accent-cool/20\">\n
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Adding IP Camera to motionEye on Home Assistant OS</h1>\n    <div class=\"flex
  ...
  raw.md: "---\ndate: 2022-06-26 14:24:25\ntemplateKey: til\ntitle: Adding IP Camera
    to motionEye on Home Assistant OS\npublished: False\ntags:\n  - homelab\n  - tech\n
    \ - cameras\n  - til\n\n---\n\n1. Dropdown menue in upper left - doesn't look
    like one but just click the name of the current device.\n2. URL will be `rtsp://<ip
    address>` <- this was the ticket for me\n"
published: false
slug: adding-ip-camera-to-motioneye-on-home-assistant-os
