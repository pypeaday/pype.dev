...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Adding IP Camera
    ...
    md:text-5xl font-bold text-text-heading mb-4\">Adding IP Camera to motionEye on
    Home Assistant OS</h1>\n    <div class=\"flex items-center text-sm text-text-main/80
    ...
    menue in upper left - doesn't look like one but just click the name of the current
    device.</li>\n<li>URL will be <code>rtsp://&lt;ip address&gt;</code> &lt;- this
    was the ticket for me</li>\n</ol>\n\n    </section>\n</article>        </div>\n
    \   </main>\n\n</div>\n     </body>\n</html>"
  ...
  partial: "<article class='w-full'>\n<section class=\"post-header mb-8\">\n    <h1
    ...
    lg:prose-xl max-w-none mx-auto mt-8\">\n        <ol>\n<li>Dropdown menue in upper
    left - doesn't look like one but just click the name of the current device.</li>\n<li>URL
