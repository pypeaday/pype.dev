---
content: "<a href=\"https://docs.openwebui.com/tutorials/web-search/searxng/\">\n
  ...
  \       alt=\"shot of post - \U0001F4AD SearXNG | Open WebUI\"\n        height=450\n
  \       width=800\n    >\n</a>\n\nHere's my thought on <a href=\"https://docs.openwebui.com/tutorials/web-search/searxng/\">\U0001F4AD
  SearXNG | Open WebUI</a>\n\n---\n\nI've been meaning to set searxng for a while
  - it comes out of the box with khoj but I want an instance for open-webui as I get
  serious about deciding on a self-hosted AI tool-chain solution. It look like the
  setup for open-webui is a touch more than \"docker compose up\" so it'll take probably
  15-20 minutes of dedicated time to try this out\n\n---\n\n!!! note\n     This is
  ...
  more about the process [[ thoughts ]]\n\n\n---\n\n['open-webui', 'search', 'ai',
  'self-hosted', 'thoughts']"
date: 2025-05-25
description: I've been meaning to set searxng for a while - it comes out of the box
  with khoj but I want an instance for open-webui a
html:
  index: "<html lang=\"en\">\n    <head>\n<title>\U0001F4AD SearXNG | Open WebUI</title>\n<meta
    charset=\"UTF-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<meta
    name=\"description\" content=\"I've been meaning to set searxng for a while -
    it comes out of the box with khoj but I want an instance for open-webui a\">\n
    ...
    \   <img src=\"https://shots.wayl.one/shot/?url=https://docs.openwebui.com/tutorials/web-search/searxng/&amp;height=450&amp;width=800&amp;scaled_width=800&amp;scaled_height=450&amp;selectors=\"
    \" alt=\"shot of post - \U0001F4AD SearXNG | Open WebUI\" height=\"450\" width=\"800\">\n</a>\n<p>Here's
    my thought on <a href=\"https://docs.openwebui.com/tutorials/web-search/searxng/\">\U0001F4AD
    SearXNG | Open WebUI</a></p>\n<hr>\n<p>I've been meaning to set searxng for a
    while - it comes out of the box with khoj but I want an instance for open-webui
    as I get serious about deciding on a self-hosted AI tool-chain solution. It look
    like the setup for open-webui is a touch more than \"docker compose up\" so it'll
    take probably 15-20 minutes of dedicated time to try this out</p>\n<hr>\n<div
    ...
    \       </a>\n    </span>\n</p>\n</div>\n<hr>\n<p>['open-webui', 'search', 'ai',
    'self-hosted', 'thoughts']</p>\n\n    </section>\n</article>        </div>\n    </main>\n\n</div>\n
    \    </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>\U0001F4AD SearXNG
    | Open WebUI</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width,
    initial-scale=1\" />\n<meta name=\"description\" content=\"I've been meaning to
    set searxng for a while - it comes out of the box with khoj but I want an instance
    for open-webui a\" />\n <link href=\"/favicon.ico\" rel=\"icon\" type=\"image/png\"
    ...
    font-bold text-text-heading mb-4\">\U0001F4AD SearXNG | Open WebUI</h1>\n    <div
    class=\"flex items-center text-sm text-text-main/80 mb-6\">\n        <time datetime=\"2025-05-25\">\n
    \           May 25, 2025\n        </time>\n    </div>\n    <div class=\"flex flex-wrap
    gap-2\">\n            <a href=\"https://pype.dev//tags/open-webui/\" class=\"inline-block
    bg-primary-light text-accent-cool text-xs font-medium px-3 py-1 rounded-full hover:bg-primary-light/80
    transition-colors border border-accent-cool/20\">\n                #open-webui\n
    \           </a>\n            <a href=\"https://pype.dev//tags/search/\" class=\"inline-block
    bg-primary-light text-accent-cool text-xs font-medium px-3 py-1 rounded-full hover:bg-primary-light/80
    transition-colors border border-accent-cool/20\">\n                #search\n            </a>\n
    \           <a href=\"https://pype.dev//tags/ai/\" class=\"inline-block bg-primary-light
    text-accent-cool text-xs font-medium px-3 py-1 rounded-full hover:bg-primary-light/80
    transition-colors border border-accent-cool/20\">\n                #ai\n            </a>\n
    \           <a href=\"https://pype.dev//tags/self-hosted/\" class=\"inline-block
    bg-primary-light text-accent-cool text-xs font-medium px-3 py-1 rounded-full hover:bg-primary-light/80
    transition-colors border border-accent-cool/20\">\n                #self-hosted\n
  ...
  partial: "<article class=\"w-full overflow-x-hidden\">\n<section class=\"post-header
    ...
    mb-4\">\U0001F4AD SearXNG | Open WebUI</h1>\n    <div class=\"flex items-center
  ...
  raw.md: "\n<a href=\"https://docs.openwebui.com/tutorials/web-search/searxng/\">\n
    ...
    \       width=800\n    >\n</a>\n\nHere's my thought on <a href=\"https://docs.openwebui.com/tutorials/web-search/searxng/\">\U0001F4AD
    SearXNG | Open WebUI</a>\n\n---\n\nI've been meaning to set searxng for a while
    - it comes out of the box with khoj but I want an instance for open-webui as I
    get serious about deciding on a self-hosted AI tool-chain solution. It look like
    the setup for open-webui is a touch more than \"docker compose up\" so it'll take
    probably 15-20 minutes of dedicated time to try this out\n\n---\n\n!!! note\n
...
published: true
slug: thoughts-643
title: "\U0001F4AD SearXNG | Open WebUI"
