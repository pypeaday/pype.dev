...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>cheat on your man</title>\n<meta
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    dark:prose-invert mx-auto mt-8\">\n        <p><code>man</code> can be a pain to
    read... and there's lots of alternatives out there and one I've just started playing
    with is <a href=\"https://github.com/cheat/cheat\">cheat</a></p>\n<p><code>man
