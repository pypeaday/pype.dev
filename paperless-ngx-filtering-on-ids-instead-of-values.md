...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Paperless-NGX filtering
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Paperless-NGX
    ...
    lg:prose-xl mx-auto mt-8\">\n        <p>To filter for saved views from the admin
    console you have to use the <code>id</code> of\nthe tag you are using to filter
    on...</p>\n<p>Ex: filtering for tags &quot;Inbox&quot; doesn't work, but for tag
    18 does (the id fo the\nInbox tag). I can find that ID by clicking on the tag
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Paperless-NGX filtering
    ...
    font-bold text-text-heading mb-4\">Paperless-NGX filtering on IDs instead of values</h1>\n
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Paperless-NGX filtering on IDs instead of values</h1>\n    <div class=\"flex
