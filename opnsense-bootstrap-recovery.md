...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>OPNSense Bootstrap
    ...
    -->\n<!-- Regular post meta tags -->\n<meta property=\"og:title\" content=\"OPNSense
    Bootstrap Recovery | Nic Payne\" />\n<meta property=\"og:description\" content=\"enabling
    DHCP WAN port (`dhclient &lt;iface&gt;`)- running the bootstrap script - `sh /usr/local/sbin/opnsense-bootstrap`\"
    />\n<meta property=\"og:image\" content=\"https://cdn.statically.io/gh/pypeaday/pype.dev/main/pages/media/og-02.png\"
    />\n<meta property=\"og:url\" content=\"https://pype.devopnsense-bootstrap-recovery\"
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    gradient-text mb-4 post-title-large\">OPNSense Bootstrap Recovery</h1>\n    <div
    ...
    dark:prose-invert lg:prose-xl mx-auto mt-8\">\n        <p>enabling DHCP WAN port
    (<code>dhclient &lt;iface&gt;</code>)- running the bootstrap script - <code>sh
    /usr/local/sbin/opnsense-bootstrap</code></p>\n\n    </section>\n</article>        </div>\n
    \   </main>\n\n</div>\n     </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>OPNSense Bootstrap
    Recovery</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width,
    initial-scale=1\" />\n<meta name=\"description\" content=\"enabling DHCP WAN port
