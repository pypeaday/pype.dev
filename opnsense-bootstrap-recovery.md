...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>OPNSense Bootstrap
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">OPNSense
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>OPNSense Bootstrap
    ...
    font-bold text-text-heading mb-4\">OPNSense Bootstrap Recovery</h1>\n    <div
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">OPNSense Bootstrap Recovery</h1>\n    <div class=\"flex items-center text-sm
