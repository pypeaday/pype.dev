...
article_html: "<p>My current homelab setup is not great but it works...</p>\n<h1 id=\"proxmox-on-poweredge-r610\">Proxmox
  ...
  .8rem;\n    }\n    .prevnext-title {\n      color: var(--prevnext-color-text);\n
  \     font-size: 1rem;\n    }\n    .prevnext-text {\n      max-width: 30vw;\n    }\n
  \   </style>\n\n    <a class='prev' href='/nextcloud-docker-upgrade-error'>\n\n\n
  ...
  Docker Upgrade Error</p>\n        </div>\n    </a>\n\n    <a class='next' href='/initial-proxmox-setup'>\n\n
  \       <div class='prevnext-text'>\n            <p class='prevnext-subtitle'>next</p>\n
  \           <p class='prevnext-title'>Initial Proxmox Setup</p>\n        </div>\n
  \       <svg width=\"50px\" height=\"50px\" viewbox=\"0 0 24 24\" fill=\"none\"
...
long_description: My current homelab setup is not great but it works... I boot off
  ...
  Currently there is
now: 2024-10-12 11:09:11.872415
...
<div class='prevnext'>
    ...
    <a class='prev' href='/nextcloud-docker-upgrade-error'>
        ...
        <div class='prevnext-text'>
            <p class='prevnext-subtitle'>prev</p>
            <p class='prevnext-title'>Nextcloud Docker Upgrade Error</p>
        </div>
    </a>
