...
article_html: "<p>I've started using <a href=\"https://www.terraform.io/\">Terraform</a>
  ...
  .8rem;\n    }\n    .prevnext-title {\n      color: var(--prevnext-color-text);\n
  \     font-size: 1rem;\n    }\n    .prevnext-text {\n      max-width: 30vw;\n    }\n
  \   </style>\n\n    <a class='prev' href='/switching-from-altacv-to-rendercv-for-my-resume'>\n\n\n
  ...
  \           <p class='prevnext-subtitle'>prev</p>\n            <p class='prevnext-title'>Switching
  from AltaCV to RenderCV for my Resume</p>\n        </div>\n    </a>\n\n    <a class='next'
  href='/self-hosted-docker-registry-with-proxy-pull-through'>\n\n        <div class='prevnext-text'>\n
  \           <p class='prevnext-subtitle'>next</p>\n            <p class='prevnext-title'>Self-hosted
  Docker registry with proxy pull through</p>\n        </div>\n        <svg width=\"50px\"
...
now: 2024-08-01 13:40:17.987193
...
<div class='prevnext'>
    ...
    <a class='next' href='/self-hosted-docker-registry-with-proxy-pull-through'>
    
        <div class='prevnext-text'>
            <p class='prevnext-subtitle'>next</p>
            <p class='prevnext-title'>Self-hosted Docker registry with proxy pull through</p>
        </div>
        <svg width="50px" height="50px" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
