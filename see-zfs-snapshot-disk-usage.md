---
content: 'As I was cleaning up my NAS recently I noticed that I ran out of storage
  even
  ...
  `zfs list-o space tank/home` will show the disk usage of the dataset and snapshots
  in `tank/home`'
date: 2022-05-19
description: 'As I was cleaning up my NAS recently I noticed that I ran out of storage
  ...
  ZF'
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>See ZFS snapshot
    disk usage</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width,
    initial-scale=1\" />\n<meta name=\"description\" content=\"As I was cleaning up
    my NAS recently I noticed that I ran out of storage even\nthough my disk usage
    looked pretty low... turns out I was keeping a mega-ton of\nZF\" />\n <link href=\"/favicon.ico\"
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">See
    ZFS snapshot disk usage</h1>\n    <div class=\"flex items-center text-sm text-text-main/80
    ...
    up my NAS recently I noticed that I ran out of storage even\nthough my disk usage
    looked pretty low... turns out I was keeping a mega-ton of\nZFS snapshots and
    due to my own ignorance at the time didn't realize the\nstorage cost of this!</p>\n<p><code>zfs
    list-o space tank/home</code> will show the disk usage of the dataset and snapshots
    in <code>tank/home</code></p>\n\n    </section>\n</article>        </div>\n    </main>\n\n</div>\n
    \    </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>See ZFS snapshot disk
    usage</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width,
    initial-scale=1\" />\n<meta name=\"description\" content=\"As I was cleaning up
    my NAS recently I noticed that I ran out of storage even\nthough my disk usage
    looked pretty low... turns out I was keeping a mega-ton of\nZF\" />\n <link href=\"/favicon.ico\"
    ...
    font-bold text-text-heading mb-4\">See ZFS snapshot disk usage</h1>\n    <div
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">See ZFS snapshot disk usage</h1>\n    <div class=\"flex items-center text-sm
    ...
    lg:prose-xl mx-auto mt-8\">\n        <p>As I was cleaning up my NAS recently I
    noticed that I ran out of storage even\nthough my disk usage looked pretty low...
    turns out I was keeping a mega-ton of\nZFS snapshots and due to my own ignorance
    at the time didn't realize the\nstorage cost of this!</p>\n<p><code>zfs list-o
    space tank/home</code> will show the disk usage of the dataset and snapshots in
    <code>tank/home</code></p>\n\n    </section>\n</article>"
  raw.md: "---\ndate: 2022-05-19 06:05:23\ntemplateKey: til\ntitle: See ZFS snapshot
    disk usage\npublished: True\ntags:\n  - zfs\n  - homelab\n  - tech\n  - til\n\n---\n\nAs
    I was cleaning up my NAS recently I noticed that I ran out of storage even\nthough
    my disk usage looked pretty low... turns out I was keeping a mega-ton of\nZFS
    snapshots and due to my own ignorance at the time didn't realize the\nstorage
    cost of this!\n\n`zfs list-o space tank/home` will show the disk usage of the
    dataset and snapshots in `tank/home`\n"
published: true
