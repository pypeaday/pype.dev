...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Psutil-01</title>\n<meta
    ...
    | Nic Payne\" />\n<meta property=\"og:description\" content=\"[Mike Driscoll](https://twitter.com/driscollis)
    has been posting some awesome posts about `psutil` lately.\nI&#x27;m interested
    in making my own system monitorin\" />\n<meta property=\"og:image\" content=\"media/psutil-01.png\"
    />\n<meta property=\"og:url\" content=\"https://pype.devpsutils-01\" />\n<meta
    ...
    about `psutil` lately.\nI&#x27;m interested in making my own system monitorin\"
    />\n<meta name=\"twitter:image\" content=\"media/psutil-01.png\" />\n<!-- Common
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    mt-8\">\n        <p><a href=\"https://twitter.com/driscollis\">Mike Driscoll</a>
    has been posting some awesome posts about <code>psutil</code> lately.\nI'm interested
    in making my own system monitoring dashboard now using this library.\nI don't
    expect it to compete with Netdata or Glances but it'll just be for fun to see
    how Python can solve this problem!</p>\n<p><strong>Repo coming soon</strong></p>\n<h2
