...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>See git history
    ...
    />\n<meta property=\"og:url\" content=\"https://pype.devsee-git-history-about-one-file\"
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    dark:prose-invert lg:prose-xl mx-auto mt-8\">\n        <p>In vim <code>G clog
    %</code> does a <code>git clog {current file}</code>. You get every commit that
    the target file is apart of (so there might be info in those commits unrelated)</p>\n\n
    \   </section>\n</article>        </div>\n    </main>\n\n</div>\n     </body>\n</html>"
