...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Tdarr worker nodes
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Tdarr
    worker nodes share the cache!</h1>\n    <div class=\"flex items-center text-sm
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Tdarr worker nodes
    ...
    font-bold text-text-heading mb-4\">Tdarr worker nodes share the cache!</h1>\n
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Tdarr worker nodes share the cache!</h1>\n    <div class=\"flex items-center
