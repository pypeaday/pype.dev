...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Nextcloud permissions
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Nextcloud
    permissions with ZFS and Ansible-NAS</h1>\n    <div class=\"flex items-center
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Nextcloud permissions
    ...
    font-bold text-text-heading mb-4\">Nextcloud permissions with ZFS and Ansible-NAS</h1>\n
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Nextcloud permissions with ZFS and Ansible-NAS</h1>\n    <div class=\"flex
