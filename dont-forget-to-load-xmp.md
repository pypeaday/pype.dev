...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Don't forget to
    ...
    md:text-5xl font-bold text-text-heading mb-4\">Don't forget to load XMP!</h1>\n
  ...
  partial: "<article class='w-full'>\n<section class=\"post-header mb-8\">\n    <h1
    ...
    lg:prose-xl max-w-none mx-auto mt-8\">\n        <p>Bought some DDR4-3600 speed
    RAM but only seeing 2666? Load up the BIOS, find DRAM config or something similar,
