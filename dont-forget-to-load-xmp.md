...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Don't forget to
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Don't
    forget to load XMP!</h1>\n    <div class=\"flex items-center text-sm text-text-main/80
    ...
    lg:prose-xl mx-auto mt-8\">\n        <p>Bought some DDR4-3600 speed RAM but only
    seeing 2666? Load up the BIOS, find DRAM config or something similar, and make
    sure to load the XMP profile to get that advertised RAM speed!</p>\n\n    </section>\n</article>
    \       </div>\n    </main>\n\n</div>\n     </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Don't forget to load
    ...
    font-bold text-text-heading mb-4\">Don't forget to load XMP!</h1>\n    <div class=\"flex
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Don't forget to load XMP!</h1>\n    <div class=\"flex items-center text-sm
