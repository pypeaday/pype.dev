...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Don't forget to
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    dark:prose-invert mx-auto mt-8\">\n        <p>Bought some DDR4-3600 speed RAM
    but only seeing 2666? Load up the BIOS, find DRAM config or something similar,
    and make sure to load the XMP profile to get that advertised RAM speed!</p>\n\n
    \   </section>\n</article>        </div>\n    </main>\n\n</div>\n     </body>\n</html>"
