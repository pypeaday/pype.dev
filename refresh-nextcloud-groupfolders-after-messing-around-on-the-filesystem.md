...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Refresh Nextcloud
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Refresh
    Nextcloud Groupfolders after messing around on the filesystem</h1>\n    <div class=\"flex
    ...
    lg:prose-xl mx-auto mt-8\">\n        <p>Exec in as www-data and run ./occ groupfolders:scan
    folder_id -v (the -v to see what it's doing)</p>\n\n    </section>\n</article>
    \       </div>\n    </main>\n\n</div>\n     </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Refresh Nextcloud Groupfolders
    ...
    font-bold text-text-heading mb-4\">Refresh Nextcloud Groupfolders after messing
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Refresh Nextcloud Groupfolders after messing around on the filesystem</h1>\n
