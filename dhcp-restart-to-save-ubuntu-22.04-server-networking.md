...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>DHCP Restart to
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">DHCP
    Restart to Save Ubuntu 22.04 Server Networking</h1>\n    <div class=\"flex items-center
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>DHCP Restart to Save
    ...
    font-bold text-text-heading mb-4\">DHCP Restart to Save Ubuntu 22.04 Server Networking</h1>\n
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">DHCP Restart to Save Ubuntu 22.04 Server Networking</h1>\n    <div class=\"flex
