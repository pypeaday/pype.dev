...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>docker context (and
    ...
    md:text-5xl font-bold text-text-heading mb-4\">docker context (and an issue to
    question your sanity)</h1>\n    <div class=\"flex items-center text-sm text-text-main/80
    ...
    lg:prose-xl max-w-none mx-auto mt-8\">\n        <p>docker contexts are great,
    would recommend putting them in your prompt though (via starship or something
