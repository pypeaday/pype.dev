...
article_html: "<p><a href=\"https://bibleproject.com/bible-studies/abraham-and-melchizedek/\">link
  ...
  .8rem;\n    }\n    .prevnext-title {\n      color: var(--prevnext-color-text);\n
  \     font-size: 1rem;\n    }\n    .prevnext-text {\n      max-width: 30vw;\n    }\n
  \   </style>\n\n    <a class='prev' href='/quick-setup-of-zfs-encrytped-datasets-with-sane-permissions'>\n\n\n
  ...
  \           <p class='prevnext-subtitle'>prev</p>\n            <p class='prevnext-title'>Quick
  setup of ZFS encrytped datasets with sane permissions</p>\n        </div>\n    </a>\n\n
  \   <a class='next' href='/append-string-to-list-of-files-with-xarg'>\n\n        <div
  class='prevnext-text'>\n            <p class='prevnext-subtitle'>next</p>\n            <p
  class='prevnext-title'>Append string to list of files with xarg</p>\n        </div>\n
  \       <svg width=\"50px\" height=\"50px\" viewbox=\"0 0 24 24\" fill=\"none\"
...
long_description: God creates Eden in which he places humans to be his royal image
  ...
  gods - Salem is ancie
now: 2024-01-05 14:15:22.253598
path: pages/bible-project/abraham-and-melchizedek.md
published: true
slug: abraham-and-melchizedek
super_description: 'God creates Eden in which he places humans to be his royal image
  - priests. God God chooses Abraham and Sarah as the first royal priesthood as they
  are chosen A priestly king of Salem. Melchizedek recognizes Yahweh as the God of
  gods - Salem is ancient short name for Jerusalem. Abraham and Sarah are promised
  their own children but they take amtters into DUring the Isaac sacrifice narrative
  a ram is given in place and Abraham names the place  The story of God ! ! ! ! !
  ! ! | Genesis 14 | Genesis '
tags:
- bible-project
- faith
