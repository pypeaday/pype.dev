...
article_html: "<p>Markata uses python's powerful jinja2 templating library for its
  ...
  as getting the latest post -&gt; <a href=\"/upgrading-your-kernel-can-f-you-up-whoops\">Upgrading
  your kernel can F you up... whoops</a></p>\n<p>You can also map over posts to get
  more.</p>\n<h2 id=\"last-three-posts\">Last Three Posts</h2>\n<ul>\n<li><a href=\"upgrading-your-kernel-can-f-you-up-whoops\">Upgrading
  your kernel can F you up... whoops</a></li>\n<li><a href=\"customize-k9s\">Customize
  K9s</a></li>\n<li><a href=\"git-fetch-failing-check-your-config\">Git fetch failing
  - check your config</a></li>\n</ul>\n<h2 id=\"last-three-python-posts\">Last Three
...
long_description: Markata uses python The veresion of markata used to build the site.
  ...
  get more.
now: 2024-06-26 16:50:21.523812
path: pages/jinja.md
published: true
slug: jinja
...
A python datetime object. (2024-06-26) 
...
such as getting the latest post -> [Upgrading your kernel can F you up... whoops](/upgrading-your-kernel-can-f-you-up-whoops)
...
*  [Upgrading your kernel can F you up... whoops](upgrading-your-kernel-can-f-you-up-whoops)
*  [Customize K9s](customize-k9s)
*  [Git fetch failing - check your config](git-fetch-failing-check-your-config)
