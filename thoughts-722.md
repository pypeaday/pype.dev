---
content: "<a href=\"https://nickjanetakis.com/blog/switching-pip-to-uv-in-a-dockerized-flask-or-django-app\">\n
  ...
  \       alt=\"shot of post - \U0001F4AD Switching pip to uv in a Dockerized Flask
  / Django App \u2014 Nick ...\"\n        height=450\n        width=800\n    >\n</a>\n\nHere's
  my thought on <a href=\"https://nickjanetakis.com/blog/switching-pip-to-uv-in-a-dockerized-flask-or-django-app\">\U0001F4AD
  Switching pip to uv in a Dockerized Flask / Django App \u2014 Nick ...</a>\n\n---\n\nIt's
  nice to see uv gaining popularity in so many places - and replacing vanilla pip
  with uv in containerized environments seems great due if for no other reason than
  the time you'll save in CI... A few years ago I refactored a disjointed container
  build process to use uv instead of pip, and due to the design of the build pipelines
  we went from 10-15 minute builds to 2-3 minutes... \n\n---\n\n!!! note\n     This
  ...
  'tech', 'thoughts']"
date: 2025-06-27
description: It's nice to see uv gaining popularity in so many places - and replacing
  vanilla pip with uv in containerized environmen
html:
  index: "<html lang=\"en\">\n    <head>\n<title>\U0001F4AD Switching pip to uv in
    a Dockerized Flask / Django App \u2014 Nick ...</title>\n<meta charset=\"UTF-8\">\n<meta
    name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<meta name=\"description\"
    content=\"It's nice to see uv gaining popularity in so many places - and replacing
    ...
    Switching pip to uv in a Dockerized Flask / Django App \u2014 Nick ...</h1>\n
    \   <div class=\"flex items-center text-sm text-text-main/80 mb-6\">\n        <time
    datetime=\"2025-06-27\">\n            June 27, 2025\n        </time>\n    </div>\n
    \   <div class=\"flex flex-wrap gap-2\">\n            <a href=\"https://pype.dev//tags/python/\"
    class=\"inline-block bg-primary-light text-accent-cool text-xs font-medium px-3
    py-1 rounded-full hover:bg-primary-light/80 transition-colors border border-accent-cool/20\">\n
    \               #python\n            </a>\n            <a href=\"https://pype.dev//tags/pip/\"
    class=\"inline-block bg-primary-light text-accent-cool text-xs font-medium px-3
    py-1 rounded-full hover:bg-primary-light/80 transition-colors border border-accent-cool/20\">\n
    \               #pip\n            </a>\n            <a href=\"https://pype.dev//tags/uv/\"
    class=\"inline-block bg-primary-light text-accent-cool text-xs font-medium px-3
    py-1 rounded-full hover:bg-primary-light/80 transition-colors border border-accent-cool/20\">\n
    \               #uv\n            </a>\n            <a href=\"https://pype.dev//tags/dev/\"
    class=\"inline-block bg-primary-light text-accent-cool text-xs font-medium px-3
    py-1 rounded-full hover:bg-primary-light/80 transition-colors border border-accent-cool/20\">\n
    ...
    \   <img src=\"https://shots.wayl.one/shot/?url=https://nickjanetakis.com/blog/switching-pip-to-uv-in-a-dockerized-flask-or-django-app&amp;height=450&amp;width=800&amp;scaled_width=800&amp;scaled_height=450&amp;selectors=\"
    \" alt=\"shot of post - \U0001F4AD Switching pip to uv in a Dockerized Flask /
    Django App \u2014 Nick ...\" height=\"450\" width=\"800\">\n</a>\n<p>Here's my
    thought on <a href=\"https://nickjanetakis.com/blog/switching-pip-to-uv-in-a-dockerized-flask-or-django-app\">\U0001F4AD
    Switching pip to uv in a Dockerized Flask / Django App \u2014 Nick ...</a></p>\n<hr>\n<p>It's
    nice to see uv gaining popularity in so many places - and replacing vanilla pip
    with uv in containerized environments seems great due if for no other reason than
    the time you'll save in CI... A few years ago I refactored a disjointed container
    build process to use uv instead of pip, and due to the design of the build pipelines
    we went from 10-15 minute builds to 2-3 minutes...</p>\n<hr>\n<div class=\"admonition
    ...
    'tech', 'thoughts']</p>\n\n    </section>\n</article>        </div>\n    </main>\n\n</div>\n
    \    </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>\U0001F4AD Switching
    pip to uv in a Dockerized Flask / Django App \u2014 Nick ...</title>\n<meta charset=\"UTF-8\"
    />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n<meta
    name=\"description\" content=\"It's nice to see uv gaining popularity in so many
    places - and replacing vanilla pip with uv in containerized environmen\" />\n
    ...
    font-bold text-text-heading mb-4\">\U0001F4AD Switching pip to uv in a Dockerized
    Flask / Django App \u2014 Nick ...</h1>\n    <div class=\"flex items-center text-sm
    ...
    \           <a href=\"https://pype.dev//tags/pip/\" class=\"inline-block bg-primary-light
    text-accent-cool text-xs font-medium px-3 py-1 rounded-full hover:bg-primary-light/80
    transition-colors border border-accent-cool/20\">\n                #pip\n            </a>\n
  ...
  partial: "<article class=\"w-full overflow-x-hidden\">\n<section class=\"post-header
    ...
    mb-4\">\U0001F4AD Switching pip to uv in a Dockerized Flask / Django App \u2014
    Nick ...</h1>\n    <div class=\"flex items-center text-sm text-text-main/80 mb-6\">\n
    \       <time datetime=\"2025-06-27\">\n            June 27, 2025\n        </time>\n
    \   </div>\n    <div class=\"flex flex-wrap gap-2\">\n            <a href=\"https://pype.dev//tags/python/\"
    class=\"inline-block bg-primary-light text-accent-cool text-xs font-medium px-3
...
published: true
slug: thoughts-722
title: "\U0001F4AD Switching pip to uv in a Dockerized Flask / Django App \u2014 Nick
  ..."
