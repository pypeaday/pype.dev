...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Customize K9s</title>\n<meta
    ...
    K9s | Nic Payne\" />\n<meta property=\"og:description\" content=\"To customize
    k9s use the skins from catppuccin or the ones k9s supplies Then edit your k9s
    config Other k9s skins are available [here](https://github.com/derail\" />\n<meta
    property=\"og:image\" content=\"https://cdn.statically.io/gh/pypeaday/pype.dev/main/pages/media/og-02.png\"
    />\n<meta property=\"og:url\" content=\"https://pype.devcustomize-k9s\" />\n<meta
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    gradient-text mb-4 post-title-large\">Customize K9s</h1>\n    <div class=\"flex
    ...
    dark:prose-invert lg:prose-xl mx-auto mt-8\">\n        <p>To customize k9s use
    the skins from catppuccin or the ones k9s supplies</p>\n<pre class='wrapper'>\n\n<div
