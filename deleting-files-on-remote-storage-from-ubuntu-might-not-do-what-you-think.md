...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Deleting files on
    ...
    md:text-5xl font-bold text-text-heading mb-4\">Deleting files on remote storage
    from Ubuntu might not do what you think</h1>\n    <div class=\"flex items-center
    ...
    lg:prose-xl max-w-none mx-auto mt-8\">\n        <p>From my daily driver Ubuntu
    machine I often open nautilus, dolphin, etc. and delete a file here or there on
    my NAS... turns out Ubuntu sends thse file to <code>.Trash-100</code> ON THE NAS
    so I'm effectively just moving that file and not freeing up any space...</p>\n\n
    \   </section>\n</article>        </div>\n    </main>\n\n</div>\n     </body>\n</html>"
