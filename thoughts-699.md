---
content: "<a href=\"https://discuss.hashicorp.com/t/failed-to-load-state-unsupported-checkable-object-kind-var/61844/2\">\n
  ...
  \       alt=\"shot of post - \U0001F4AD Failed to load state: unsupported checkable
  object kind var - ...\"\n        height=450\n        width=800\n    >\n</a>\n\nHere's
  my thought on <a href=\"https://discuss.hashicorp.com/t/failed-to-load-state-unsupported-checkable-object-kind-var/61844/2\">\U0001F4AD
  Failed to load state: unsupported checkable object kind var - ...</a>\n\n---\n\nI
  have spacelift stacks managed with open tofu and stacks managed with terraform...
  Due to this very issue I think, I ran into a problem where a terraform-managed spacelift
  stack couldn't use the `terraform_remote_state` data resource to load the state
  of the open-tofu managed stacks because of state file differences\n\n---\n\n!!!
  ...
  more about the process [[ thoughts ]]\n\n\n---\n\n['spacelift', 'terraform', 'infrastructure',
  'open-tofu', 'tofu', 'thoughts']"
date: 2025-06-16
description: I have spacelift stacks managed with open tofu and stacks managed with
  terraform... Due to this very issue I think, I ra
html:
  index: "<html lang=\"en\">\n    <head>\n<title>\U0001F4AD Failed to load state:
    unsupported checkable object kind var - ...</title>\n<meta charset=\"UTF-8\">\n<meta
    name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<meta name=\"description\"
    content=\"I have spacelift stacks managed with open tofu and stacks managed with
    ...
    Failed to load state: unsupported checkable object kind var - ...</h1>\n    <div
    class=\"flex items-center text-sm text-text-main/80 mb-6\">\n        <time datetime=\"2025-06-16\">\n
    \           June 16, 2025\n        </time>\n    </div>\n    <div class=\"flex
    flex-wrap gap-2\">\n            <a href=\"https://pype.dev//tags/spacelift/\"
    ...
    class=\"inline-block bg-primary-light text-accent-cool text-xs font-medium px-3
    py-1 rounded-full hover:bg-primary-light/80 transition-colors border border-accent-cool/20\">\n
    \               #infrastructure\n            </a>\n            <a href=\"https://pype.dev//tags/open-tofu/\"
    class=\"inline-block bg-primary-light text-accent-cool text-xs font-medium px-3
    py-1 rounded-full hover:bg-primary-light/80 transition-colors border border-accent-cool/20\">\n
    \               #open-tofu\n            </a>\n            <a href=\"https://pype.dev//tags/tofu/\"
    class=\"inline-block bg-primary-light text-accent-cool text-xs font-medium px-3
    py-1 rounded-full hover:bg-primary-light/80 transition-colors border border-accent-cool/20\">\n
    ...
    \   <img src=\"https://shots.wayl.one/shot/?url=https://discuss.hashicorp.com/t/failed-to-load-state-unsupported-checkable-object-kind-var/61844/2&amp;height=450&amp;width=800&amp;scaled_width=800&amp;scaled_height=450&amp;selectors=\"
    \" alt=\"shot of post - \U0001F4AD Failed to load state: unsupported checkable
    object kind var - ...\" height=\"450\" width=\"800\">\n</a>\n<p>Here's my thought
    on <a href=\"https://discuss.hashicorp.com/t/failed-to-load-state-unsupported-checkable-object-kind-var/61844/2\">\U0001F4AD
    Failed to load state: unsupported checkable object kind var - ...</a></p>\n<hr>\n<p>I
    have spacelift stacks managed with open tofu and stacks managed with terraform...
    Due to this very issue I think, I ran into a problem where a terraform-managed
    spacelift stack couldn't use the <code>terraform_remote_state</code> data resource
    ...
    \       </a>\n    </span>\n</p>\n</div>\n<hr>\n<p>['spacelift', 'terraform', 'infrastructure',
    'open-tofu', 'tofu', 'thoughts']</p>\n\n    </section>\n</article>        </div>\n
    \   </main>\n\n</div>\n     </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>\U0001F4AD Failed to
    load state: unsupported checkable object kind var - ...</title>\n<meta charset=\"UTF-8\"
    />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n<meta
    name=\"description\" content=\"I have spacelift stacks managed with open tofu
    and stacks managed with terraform... Due to this very issue I think, I ra\" />\n
    ...
    font-bold text-text-heading mb-4\">\U0001F4AD Failed to load state: unsupported
    checkable object kind var - ...</h1>\n    <div class=\"flex items-center text-sm
    text-text-main/80 mb-6\">\n        <time datetime=\"2025-06-16\">\n            June
    16, 2025\n        </time>\n    </div>\n    <div class=\"flex flex-wrap gap-2\">\n
    \           <a href=\"https://pype.dev//tags/spacelift/\" class=\"inline-block
  ...
  partial: "<article class=\"w-full overflow-x-hidden\">\n<section class=\"post-header
    ...
    mb-4\">\U0001F4AD Failed to load state: unsupported checkable object kind var
  ...
  raw.md: "\n<a href=\"https://discuss.hashicorp.com/t/failed-to-load-state-unsupported-checkable-object-kind-var/61844/2\">\n
    ...
    have spacelift stacks managed with open tofu and stacks managed with terraform...
    Due to this very issue I think, I ran into a problem where a terraform-managed
    spacelift stack couldn't use the `terraform_remote_state` data resource to load
    the state of the open-tofu managed stacks because of state file differences\n\n---\n\n!!!
    note\n     This is one of [[ my-thoughts ]]. I picked this up from [Waylon Walker](https://waylonwalker.com)(https://thoughts.waylonwalker.com).
    It's a short note that I make about someone else's\n     content online.  Learn
    more about the process [[ thoughts ]]\n\n\n---\n\n['spacelift', 'terraform', 'infrastructure',
    'open-tofu', 'tofu', 'thoughts']\n        "
published: true
slug: thoughts-699
title: "\U0001F4AD Failed to load state: unsupported checkable object kind var - ..."
