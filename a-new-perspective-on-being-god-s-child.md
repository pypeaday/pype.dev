...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>A New Perspective
    ...
    alt=\"A New Perspective on Being God's Child cover image\" class=\"w-full object-cover
    rounded-lg shadow-2xl border-4 border-white dark:border-gray-600\" style=\"max-height:
    400px;\">\n    </div>\n<section class=\"post-header mb-8\">\n    <h1 id=\"title\"
    class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">A New Perspective
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>A New Perspective on
    ...
    font-bold text-text-heading mb-4\">A New Perspective on Being God's Child</h1>\n
