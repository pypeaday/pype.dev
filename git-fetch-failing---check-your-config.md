...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Git fetch failing
    ...
    />\n<meta property=\"og:url\" content=\"https://pype.devgit-fetch-failing-check-your-config\"
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    mt-8\">\n        <p>I started deploying a website to Cloudflare on a branch called
    <code>pages</code>. Similar to one of the GH Pages deployment patterns. But when
    my CI was pushing the branch I couldn't see it locally...</p>\n<p><code>git fetch
    -a</code> wasn't pulling any new branches, and <code>git branch -a</code> was
    only showing my development and main branches at the remote... so what gives?</p>\n<p>I
