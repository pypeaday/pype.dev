...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Git fetch failing
    ...
    md:text-5xl font-bold text-text-heading mb-4\">Git fetch failing - check your
  ...
  partial: "<article class='w-full'>\n<section class=\"post-header mb-8\">\n    <h1
    ...
    lg:prose-xl max-w-none mx-auto mt-8\">\n        <p>I started deploying a website
    to Cloudflare on a branch called <code>pages</code>. Similar to one of the GH
    Pages deployment patterns. But when my CI was pushing the branch I couldn't see
