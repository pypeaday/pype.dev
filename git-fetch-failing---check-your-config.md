...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Git fetch failing
    ...
    fetch failing - check your config</h1>\n    <div class=\"flex items-center text-sm
    ...
    on a branch called <code>pages</code>. Similar to one of the GH Pages deployment
    patterns. But when my CI was pushing the branch I couldn't see it locally...</p>\n<p><code>git
    fetch -a</code> wasn't pulling any new branches, and <code>git branch -a</code>
    was only showing my development and main branches at the remote... so what gives?</p>\n<p>I
    checked my git config, and to this moment I have no idea how this happened but
    check out my fetch config:</p>\n<pre class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Git fetch failing -
    ...
    font-bold text-text-heading mb-4\">Git fetch failing - check your config</h1>\n
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Git fetch failing - check your config</h1>\n    <div class=\"flex items-center
