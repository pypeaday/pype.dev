...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>suda.vim for sudo
    ...
    md:text-5xl font-bold text-text-heading mb-4\">suda.vim for sudo access to files</h1>\n
    ...
    need to edit system config files - take /etc/sanoid/sanoid.conf as\nan example...
    I'll want to play with something but if I don't start Neovim as\nroot then I get
    in trouble making edits I can't save! So\n<a href=\"https://github.com/lambdalisue/suda.vim\">suda.vim</a>
  ...
  partial: "<article class='w-full'>\n<section class=\"post-header mb-8\">\n    <h1
    ...
    mx-auto mt-8\">\n        <p>I regularly need to edit system config files - take
    /etc/sanoid/sanoid.conf as\nan example... I'll want to play with something but
    if I don't start Neovim as\nroot then I get in trouble making edits I can't save!
    ...
    is running with my login user!</p>\n\n    </section>\n</article>"
