...
article_html: "<p>I regularly need to edit system config files - take /etc/sanoid/sanoid.conf
  ...
  .8rem;\n    }\n    .prevnext-title {\n      color: var(--prevnext-color-text);\n
  \     font-size: 1rem;\n    }\n    .prevnext-text {\n      max-width: 30vw;\n    }\n
  \   </style>\n\n    <a class='prev' href='/adding-docker-daemon-json-broke-docker'>\n\n\n
  ...
  docker daemon.json broke docker</p>\n        </div>\n    </a>\n\n    <a class='next'
...
long_description: I regularly need to edit system config files - take /etc/sanoid/sanoid.conf
  as
now: 2024-10-12 11:09:11.872070
...
<div class='prevnext'>
    ...
    <a class='prev' href='/adding-docker-daemon-json-broke-docker'>
        ...
        <div class='prevnext-text'>
            <p class='prevnext-subtitle'>prev</p>
            <p class='prevnext-title'>Adding docker daemon.json broke docker</p>
        </div>
    </a>
