---
content: 'I regularly need to edit system config files - take /etc/sanoid/sanoid.conf
  as
...
description: 'I regularly need to edit system config files - take /etc/sanoid/sanoid.conf
  ...
  an example... I&#x27;ll want to play with something but if I don&#x27;t start Neo'
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>suda.vim for sudo
    access to files</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width,
    initial-scale=1\" />\n<meta name=\"description\" content=\"I regularly need to
    edit system config files - take /etc/sanoid/sanoid.conf as\nan example... I&#x27;ll
    want to play with something but if I don&#x27;t start Neo\" />\n <link href=\"/favicon.ico\"
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">suda.vim
    for sudo access to files</h1>\n    <div class=\"flex items-center text-sm text-text-main/80
    ...
    mt-8\">\n        <p>I regularly need to edit system config files - take /etc/sanoid/sanoid.conf
    as\nan example... I'll want to play with something but if I don't start Neovim
    ...
    \       </div>\n    </main>\n\n</div>\n     </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>suda.vim for sudo access
    to files</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width,
    initial-scale=1\" />\n<meta name=\"description\" content=\"I regularly need to
    edit system config files - take /etc/sanoid/sanoid.conf as\nan example... I&#x27;ll
    want to play with something but if I don&#x27;t start Neo\" />\n <link href=\"/favicon.ico\"
    ...
    font-bold text-text-heading mb-4\">suda.vim for sudo access to files</h1>\n    <div
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">suda.vim for sudo access to files</h1>\n    <div class=\"flex items-center
    ...
    lg:prose-xl mx-auto mt-8\">\n        <p>I regularly need to edit system config
    files - take /etc/sanoid/sanoid.conf as\nan example... I'll want to play with
    something but if I don't start Neovim as\nroot then I get in trouble making edits
    I can't save! So\n<a href=\"https://github.com/lambdalisue/suda.vim\">suda.vim</a>
    gives me\n<code>:SudaWrite</code> which let's me write that buffer with sudo privileges
    even though\nI'm Neovim is running with my login user!</p>\n\n    </section>\n</article>"
  raw.md: "---\ndate: 2022-12-21 09:45:34\ntemplateKey: til\ntitle: suda.vim for sudo
    access to files\npublished: True\ntags:\n  - vim\n  - linux\n  - tech\n  - til\n\n---\n\nI
    regularly need to edit system config files - take /etc/sanoid/sanoid.conf as\nan
    example... I'll want to play with something but if I don't start Neovim as\nroot
    then I get in trouble making edits I can't save! So\n[suda.vim](https://github.com/lambdalisue/suda.vim)
    gives me\n`:SudaWrite` which let's me write that buffer with sudo privileges even
    though\nI'm Neovim is running with my login user!\n"
published: true
