...
description: '`ffmpeg -i input.mp4 -map 0 -c:v libx264 -vf format=yuv420p -c:a copy
  output.mp4`'
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>FFMPEG 10-bit videos to 8-bit</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"`ffmpeg -i input.mp4 -map 0 -c:v libx264
    -vf format=yuv420p -c:a copy output.mp4`\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
  ...
  partial: "<article class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n
    \       FFMPEG 10-bit videos to 8-bit\n    </h1>\n</section>    <section class=\"body\">\n
    \       <p><code>ffmpeg -i input.mp4 -map 0 -c:v libx264 -vf format=yuv420p -c:a
    copy output.mp4</code></p>\n\n    </section>\n</article>"
