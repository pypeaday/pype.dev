---
content: '`ffmpeg -i input.mp4 -map 0 -c:v libx264 -vf format=yuv420p -c:a copy output.mp4`'
date: 2023-01-16
description: '`ffmpeg -i input.mp4 -map 0 -c:v libx264 -vf format=yuv420p -c:a copy
  output.mp4`'
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>FFMPEG 10-bit videos
    to 8-bit</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width,
    initial-scale=1\" />\n<meta name=\"description\" content=\"`ffmpeg -i input.mp4
    -map 0 -c:v libx264 -vf format=yuv420p -c:a copy output.mp4`\" />\n <link href=\"/favicon.ico\"
    ...
    property=\"og:title\" content=\"FFMPEG 10-bit videos to 8-bit | Nic Payne\" />\n<meta
    property=\"og:image\" content=\"https://cdn.statically.io/gh/pypeaday/pype.dev/main/pages/media/og-02.png\"
    />\n<meta property=\"og:url\" content=\"https://pype.dev/ffmpeg-10-bit-videos-to-8-bit\"
    />\n<meta name=\"twitter:card\" content=\"summary_large_image\">\n<meta name=\"twitter:title\"
    content=\"FFMPEG 10-bit videos to 8-bit | Nic Payne\" />\n<meta name=\"twitter:description\"
    content=\"`ffmpeg -i input.mp4 -map 0 -c:v libx264 -vf format=yuv420p -c:a copy
    ...
    \           <span class=\"site-terminal__dir\">~/ffmpeg-10-bit-videos-to-8-bit</span>\n
    ...
    mb-4 post-title-large\">FFMPEG 10-bit videos to 8-bit</h1>\n    <div class=\"flex
    ...
    prose dark:prose-invert\">\n            <p><code>ffmpeg -i input.mp4 -map 0 -c:v
    libx264 -vf format=yuv420p -c:a copy output.mp4</code></p>\n\n        </section>\n
    \   </article>\n</section>        </div>\n    </main>\n</div>\n     </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>FFMPEG 10-bit videos
    to 8-bit</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width,
    initial-scale=1\" />\n<meta name=\"description\" content=\"`ffmpeg -i input.mp4
  ...
  partial: "<section class=\"post-terminal  post-terminal--til \">\n\n    <article
    ...
    md:text-7xl font-extrabold gradient-text mb-4 post-title-large\">FFMPEG 10-bit
  ...
  protected-post: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>FFMPEG
    ...
    -i input.mp4 -map 0 -c:v libx264 -vf format=yuv420p -c:a copy output.mp4</code></p>\n\n
    \       </div>\n    </main>\n</div>\n     </body>\n</html>"
  raw.md: "---\ndate: 2023-01-16 13:15:53\ntemplateKey: til\ntitle: FFMPEG 10-bit
    videos to 8-bit\npublished: True\ntags:\n  - cli\n  - homelab\n  - tech\n  - til\n---\n\n`ffmpeg
    -i input.mp4 -map 0 -c:v libx264 -vf format=yuv420p -c:a copy output.mp4`\n"
published: true
slug: ffmpeg-10-bit-videos-to-8-bit
