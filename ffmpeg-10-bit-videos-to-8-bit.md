...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>FFMPEG 10-bit videos
    ...
    />\n<meta property=\"og:url\" content=\"https://pype.devffmpeg-10-bit-videos-to-8-bit\"
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    dark:prose-invert lg:prose-xl mx-auto mt-8\">\n        <p><code>ffmpeg -i input.mp4
    -map 0 -c:v libx264 -vf format=yuv420p -c:a copy output.mp4</code></p>\n\n    </section>\n</article>
    \       </div>\n    </main>\n\n</div>\n     </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>FFMPEG 10-bit videos
    to 8-bit</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width,
    initial-scale=1\" />\n<meta name=\"description\" content=\"`ffmpeg -i input.mp4
