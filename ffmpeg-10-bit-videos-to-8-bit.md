...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>FFMPEG 10-bit videos
    ...
    md:text-5xl font-bold text-text-heading mb-4\">FFMPEG 10-bit videos to 8-bit</h1>\n
  ...
  partial: "<article class='w-full'>\n<section class=\"post-header mb-8\">\n    <h1
    ...
    lg:prose-xl max-w-none mx-auto mt-8\">\n        <p><code>ffmpeg -i input.mp4 -map
    0 -c:v libx264 -vf format=yuv420p -c:a copy output.mp4</code></p>\n\n    </section>\n</article>"
