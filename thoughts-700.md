---
content: "<a href=\"https://stackoverflow.com/questions/12465978/can-aws-security-groups-on-one-aws-account-reference-security-groups-in-another\">\n
  ...
  \       alt=\"shot of post - \U0001F4AD Cross Account AWS Security Group ID Reference\"\n
  \       height=450\n        width=800\n    >\n</a>\n\nHere's my thought on <a href=\"https://stackoverflow.com/questions/12465978/can-aws-security-groups-on-one-aws-account-reference-security-groups-in-another\">\U0001F4AD
  Cross Account AWS Security Group ID Reference</a>\n\n---\n\nI needed to update some
  ingress rules across several AWS accounts and ran into an issue when I had to reference
  a security group id in another account - turns out <accountid>/<securitygroupid>
...
date: 2025-06-16
description: I needed to update some ingress rules across several AWS accounts and
  ran into an issue when I had to reference a securi
html:
  index: "<html lang=\"en\">\n    <head>\n<title>\U0001F4AD Cross Account AWS Security
    Group ID Reference</title>\n<meta charset=\"UTF-8\">\n<meta name=\"viewport\"
    content=\"width=device-width, initial-scale=1\">\n<meta name=\"description\" content=\"I
    needed to update some ingress rules across several AWS accounts and ran into an
    issue when I had to reference a securi\">\n <link href=\"/favicon.ico\" rel=\"icon\"
    ...
    Cross Account AWS Security Group ID Reference</h1>\n    <div class=\"flex items-center
    text-sm text-text-main/80 mb-6\">\n        <time datetime=\"2025-06-16\">\n            June
    16, 2025\n        </time>\n    </div>\n    <div class=\"flex flex-wrap gap-2\">\n
    \           <a href=\"https://pype.dev//tags/aws/\" class=\"inline-block bg-primary-light
    text-accent-cool text-xs font-medium px-3 py-1 rounded-full hover:bg-primary-light/80
    transition-colors border border-accent-cool/20\">\n                #aws\n            </a>\n
    \           <a href=\"https://pype.dev//tags/infrastructure/\" class=\"inline-block
    ...
    \   <img src=\"https://shots.wayl.one/shot/?url=https://stackoverflow.com/questions/12465978/can-aws-security-groups-on-one-aws-account-reference-security-groups-in-another&amp;height=450&amp;width=800&amp;scaled_width=800&amp;scaled_height=450&amp;selectors=\"
    \" alt=\"shot of post - \U0001F4AD Cross Account AWS Security Group ID Reference\"
    height=\"450\" width=\"800\">\n</a>\n<p>Here's my thought on <a href=\"https://stackoverflow.com/questions/12465978/can-aws-security-groups-on-one-aws-account-reference-security-groups-in-another\">\U0001F4AD
    Cross Account AWS Security Group ID Reference</a></p>\n<hr>\n<p>I needed to update
    some ingress rules across several AWS accounts and ran into an issue when I had
    to reference a security group id in another account - turns out <accountid>/<securitygroupid>
    is the money maker</securitygroupid></accountid></p>\n<p>EDIT: this requires VPC
    ...
    \       </a>\n    </span>\n</p>\n</div>\n<hr>\n<p>['aws', 'infrastructure', 'thoughts']</p>\n\n
    \   </section>\n</article>        </div>\n    </main>\n\n</div>\n     </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>\U0001F4AD Cross Account
    AWS Security Group ID Reference</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\"
    content=\"width=device-width, initial-scale=1\" />\n<meta name=\"description\"
    content=\"I needed to update some ingress rules across several AWS accounts and
    ...
    font-bold text-text-heading mb-4\">\U0001F4AD Cross Account AWS Security Group
    ID Reference</h1>\n    <div class=\"flex items-center text-sm text-text-main/80
    mb-6\">\n        <time datetime=\"2025-06-16\">\n            June 16, 2025\n        </time>\n
    \   </div>\n    <div class=\"flex flex-wrap gap-2\">\n            <a href=\"https://pype.dev//tags/aws/\"
  ...
  partial: "<article class=\"w-full overflow-x-hidden\">\n<section class=\"post-header
    ...
    mb-4\">\U0001F4AD Cross Account AWS Security Group ID Reference</h1>\n    <div
    class=\"flex items-center text-sm text-text-main/80 mb-6\">\n        <time datetime=\"2025-06-16\">\n
    \           June 16, 2025\n        </time>\n    </div>\n    <div class=\"flex
    flex-wrap gap-2\">\n            <a href=\"https://pype.dev//tags/aws/\" class=\"inline-block
    bg-primary-light text-accent-cool text-xs font-medium px-3 py-1 rounded-full hover:bg-primary-light/80
    transition-colors border border-accent-cool/20\">\n                #aws\n            </a>\n
    \           <a href=\"https://pype.dev//tags/infrastructure/\" class=\"inline-block
    bg-primary-light text-accent-cool text-xs font-medium px-3 py-1 rounded-full hover:bg-primary-light/80
  ...
  raw.md: "\n<a href=\"https://stackoverflow.com/questions/12465978/can-aws-security-groups-on-one-aws-account-reference-security-groups-in-another\">\n
    ...
    href=\"https://stackoverflow.com/questions/12465978/can-aws-security-groups-on-one-aws-account-reference-security-groups-in-another\">\U0001F4AD
    Cross Account AWS Security Group ID Reference</a>\n\n---\n\nI needed to update
    some ingress rules across several AWS accounts and ran into an issue when I had
    to reference a security group id in another account - turns out <accountid>/<securitygroupid>
    is the money maker\n\nEDIT: this requires VPC Peering...\n\n---\n\n!!! note\n
...
published: true
slug: thoughts-700
title: "\U0001F4AD Cross Account AWS Security Group ID Reference"
