---
content: <!-- Content Injected to every content markdown footer -->
date: 2022-03-09
description: ''
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>_Markdown_Footer</title>\n<meta
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">_Markdown_Footer</h1>\n
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>_Markdown_Footer</title>\n<meta
    ...
    font-bold text-text-heading mb-4\">_Markdown_Footer</h1>\n    <div class=\"flex
  ...
  raw.md: '---
    ...
    '
published: false
slug: markdown-footer
title: _Markdown_Footer
