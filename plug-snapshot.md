---
article_html: "<p>:PlugSnapshot, :w ~/dotfiles/nvim/snapshot.vim... keep your config
  safe with git!</p>\n<div class='prevnext'>\n\n    <style type='text/css'>\n\n    :root
  ...
  .8rem;\n    }\n    .prevnext-title {\n      color: var(--prevnext-color-text);\n
  \     font-size: 1rem;\n    }\n    .prevnext-text {\n      max-width: 30vw;\n    }\n
  \   </style>\n\n    <a class='prev' href='/nextcloud-permissions-with-zfs-and-ansible-nas'>\n\n\n
...
html: "<p>:PlugSnapshot, :w ~/dotfiles/nvim/snapshot.vim... keep your config safe
  with git!</p>\n<div class='prevnext'>\n\n    <style type='text/css'>\n\n    :root
  {\n      --prevnext-color-text: #d8ebe6;\n      --prevnext-color-angle: #83dcc8cc;\n
  \     --prevnext-subtitle-brightness: 3;\n    }\n    [data-theme=\"light\"] {\n
  \     --prevnext-color-text: #1f2022;\n      --prevnext-color-angle: #ffeb00;\n
...
long_description: :PlugSnapshot, :w ~/dotfiles/nvim/snapshot.vim... keep your config
  safe with git
now: 2024-08-01 13:40:17.987555
path: pages/til/plug-snapshot.md
published: true
slug: plug-snapshot
super_description: :PlugSnapshot, :w ~/dotfiles/nvim/snapshot.vim... keep your config
  safe with git
tags:
- vim
- tech
