...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>MCPHub with Windsurf</title>\n<meta
    ...
    alt=\"MCPHub with Windsurf cover image\" class=\"w-full object-cover rounded-lg
    shadow-2xl border-4 border-white dark:border-gray-600\" style=\"max-height: 400px;\">\n
    \   </div>\n<section class=\"post-header mb-8\">\n    <h1 id=\"title\" class=\"text-4xl
    md:text-5xl font-bold text-text-heading mb-4\">MCPHub with Windsurf</h1>\n    <div
    class=\"flex items-center text-sm text-text-main/80 mb-6\">\n        <time datetime=\"2025-07-03\">\n
    \           July 03, 2025\n        </time>\n    </div>\n    <div class=\"flex
    flex-wrap gap-2\">\n            <a href=\"https://pype.dev//tags/mcp/\" class=\"inline-block
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>MCPHub with Windsurf</title>\n<meta
    ...
    font-bold text-text-heading mb-4\">MCPHub with Windsurf</h1>\n    <div class=\"flex
