...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Call basicConfig
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Call
    basicConfig to get Python log messages in iPython</h1>\n    <div class=\"flex
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Call basicConfig to
    ...
    font-bold text-text-heading mb-4\">Call basicConfig to get Python log messages
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Call basicConfig to get Python log messages in iPython</h1>\n    <div class=\"flex
    items-center text-sm text-text-main/80 mb-6\">\n        <time datetime=\"2022-12-10\">\n
    \           December 10, 2022\n        </time>\n    </div>\n    <div class=\"flex
    flex-wrap gap-2\">\n            <a href=\"https://pype.dev//tags/python/\" class=\"inline-block
    bg-primary-light text-accent-cool text-xs font-medium px-3 py-1 rounded-full hover:bg-primary-light/80
