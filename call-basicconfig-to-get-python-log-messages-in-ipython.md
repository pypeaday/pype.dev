...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>Call basicConfig to get Python
    log messages in iPython</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\"
    ...
    basicConfig to get Python log messages in iPython</title>\n<meta charset=\"UTF-8\"
    />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n<meta
    name=\"description\" content=\"Logging instead of printing I am trying to adopt
    `logger.debug` instead of `print` but ran into a confusing\nthing in ipython during
    Advent of Code... I riddled \" />\n <link href=\"/favicon.ico\" rel=\"icon\" type=\"image/png\"
    />\n\n<link rel=\"stylesheet\" href=\"/post.css\" />\n<link rel=\"stylesheet\"
    href=\"/app.css\" />\n<script src=\"/theme.js\"></script>\n\n\n        <meta property=\"og:author_email\"
    ...
    class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n        Call
    basicConfig to get Python log messages in iPython\n    </h1>\n</section>    <section
    class=\"body\">\n        <h1 id=\"logging-instead-of-printing\">Logging instead
    of printing <a class=\"header-anchor\" href=\"#logging-instead-of-printing\"><svg
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>Call basicConfig to get Python
    ...
    \   <style>\n        section {\n            font-size: 200%;\n        }\n\n\n
    \       .edit {\n            display: none;\n        }\n    </style>\n<section
    class=\"title\">\n    <h1 id=\"title\">\n        Call basicConfig to get Python
    log messages in iPython\n    </h1>\n</section></article>\n     </body>\n</html>"
  ...
  raw.md: "---\ndate: 2022-12-10 14:04:23\ntemplateKey: til\ntitle: Call basicConfig
    ...
    `logger.debug` instead of `print` but ran into a confusing\nthing in ipython during
    Advent of Code... I riddled by script with\n`logger.debug` (yes after setting
    `logging.setLevel('DEBUG')`) but in ipython\nnone of my log messages showed up!\n\n```python\nimport
    logging\n\nlogger = logging.getLogger(__name__)\nlogger.setLevel(\"DEBUG\")\n\n```\n\nTurns
