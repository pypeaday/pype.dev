...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Homelabbing Realization
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    gradient-text mb-4 post-title-large\">Homelabbing Realization - Configs and Git</h1>\n
    ...
    \       <h2 id=\"realization\">Realization <a class=\"header-anchor\" href=\"#realization\"><svg
