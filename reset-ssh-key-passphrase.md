...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Reset SSH key passphrase</title>\n<meta
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Reset
    SSH key passphrase</h1>\n    <div class=\"flex items-center text-sm text-text-main/80
    ...
    prose dark:prose-invert lg:prose-xl mx-auto mt-8\">\n        <p>I got into a pickle
    where I encrypted the ssh keys I use for my SSH connections on LAN, but then I
    couldn't run my ansible playbook on my server! ssh-keygen -p and leave the new
    passphrase blank saved my day (although password protected key files are safer!)</p>\n<h1
    id=\"tldr---just-reset-it-to-nothing\">TL;DR - just reset it to nothing <a class=\"header-anchor\"
    href=\"#tldr---just-reset-it-to-nothing\"><svg class=\"heading-permalink\" aria-hidden=\"true\"
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Reset SSH key passphrase</title>\n<meta
    ...
    font-bold text-text-heading mb-4\">Reset SSH key passphrase</h1>\n    <div class=\"flex
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Reset SSH key passphrase</h1>\n    <div class=\"flex items-center text-sm
