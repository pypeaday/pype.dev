...
article_html: "<p><a href=\"https://bemadiscipleship.s3.us-east-2.amazonaws.com/BEMA+078+Silent+Years+Essenes-v2.pdf\">link
  ...
  .8rem;\n    }\n    .prevnext-title {\n      color: var(--prevnext-color-text);\n
  \     font-size: 1rem;\n    }\n    .prevnext-text {\n      max-width: 30vw;\n    }\n
  \   </style>\n\n    <a class='prev' href='/shalom-and-peace'>\n\n\n        <svg
...
now: 2024-10-12 11:09:11.872448
path: pages/bema/078-silent-years---essenes.md
published: 'False'
slug: 078-silent-years-essenes
status: published
super_description: 'During the  Another Jewish group (like Pharisees, Herodians, etc.)
  with a lot of debate ! Essenes are credeited with writing the DSS. These served
  to validate basically all of what we have in our modern translated Bibles Can only
  come from a spring or rain. Living water is what  Another passage Essenes hold to
  is Isaiah 40: ! ! Unlike Herodians who went out and engaged the world (not that
  everything they'
tags:
- bema
