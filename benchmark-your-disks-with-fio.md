...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Benchmark your disks
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Benchmark
    your disks with fio</h1>\n    <div class=\"flex items-center text-sm text-text-main/80
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Benchmark your disks
    ...
    font-bold text-text-heading mb-4\">Benchmark your disks with fio</h1>\n    <div
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Benchmark your disks with fio</h1>\n    <div class=\"flex items-center
