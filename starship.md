...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Starship</title>\n<meta
    ...
    class='w-full'>\n    <div class=\"mt-8 mb-8 -mx-8\">\n        <img src=\"/media/starship.png\"
    alt=\"Starship cover image\" class=\"w-full object-cover rounded-lg shadow-2xl
    ...
    lg:prose-xl max-w-none mx-auto mt-8\">\n        <p>If you spend time in the terminal
    then you'll want it to look somewhat pleasing to the eye.\nI used to ssh into
    servers with no customization, use <code>vi</code>  to edit a file or two, then
    get back to my regularly scheduled programming in VS C**e...</p>\n<p>One of the
    first steps for me loving my terminal was a beautiful prompt...</p>\n<h2 id=\"prompt\">Prompt
