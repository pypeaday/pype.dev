---
content: "<a href=\"https://github.com/pypeaday/whose-turn-is-it\">\n    <img\n        src=\"https://shots.wayl.one/shot/?url=https://github.com/pypeaday/whose-turn-is-it&height=450&width=800&scaled_width=800&scaled_height=450&selectors=\"\"\n
  \       alt=\"shot of post - \U0001F4AD pypeaday/whose-turn-is-it: Simple uv webapp
  to determine order...\"\n        height=450\n        width=800\n    >\n</a>\n\nHere's
  my thought on <a href=\"https://github.com/pypeaday/whose-turn-is-it\">\U0001F4AD
  pypeaday/whose-turn-is-it: Simple uv webapp to determine order...</a>\n\n---\n\nWe
  pray together as a family every night, but every single flipping night my daughter's
  fight about the order we go in... well, NO MORE!\n\nI built a simple uv fastapi
  app that randomly sorts a list from an environment var `PLAYERS` and presents it
  in the web page at `/generate`.\n\nSuper easy `uv run` at home...\n\nI love that
  with enough knowledge, or the right kind of knowledge, you can build like anything
  ...
  more about the process [[ thoughts ]]\n\n\n---\n\n['homelab', 'tech', 'reflection',
  'thoughts']"
date: 2025-06-20
description: We pray together as a family every night, but every single flipping night
  my daughter's fight about the order we go in..
html:
  index: "<html lang=\"en\">\n    <head>\n<title>\U0001F4AD pypeaday/whose-turn-is-it:
    Simple uv webapp to determine order...</title>\n<meta charset=\"UTF-8\">\n<meta
    name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<meta name=\"description\"
    content=\"We pray together as a family every night, but every single flipping
    night my daughter's fight about the order we go in..\">\n <link href=\"/favicon.ico\"
    ...
    pypeaday/whose-turn-is-it: Simple uv webapp to determine order...</h1>\n    <div
    ...
    \   <img src=\"https://shots.wayl.one/shot/?url=https://github.com/pypeaday/whose-turn-is-it&amp;height=450&amp;width=800&amp;scaled_width=800&amp;scaled_height=450&amp;selectors=\"
    \" alt=\"shot of post - \U0001F4AD pypeaday/whose-turn-is-it: Simple uv webapp
    to determine order...\" height=\"450\" width=\"800\">\n</a>\n<p>Here's my thought
    on <a href=\"https://github.com/pypeaday/whose-turn-is-it\">\U0001F4AD pypeaday/whose-turn-is-it:
    Simple uv webapp to determine order...</a></p>\n<hr>\n<p>We pray together as a
    family every night, but every single flipping night my daughter's fight about
    the order we go in... well, NO MORE!</p>\n<p>I built a simple uv fastapi app that
    randomly sorts a list from an environment var <code>PLAYERS</code> and presents
    it in the web page at <code>/generate</code>.</p>\n<p>Super easy <code>uv run</code>
    at home...</p>\n<p>I love that with enough knowledge, or the right kind of knowledge,
    you can build like anything you want!</p>\n<hr>\n<div class=\"admonition note
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>\U0001F4AD pypeaday/whose-turn-is-it:
    ...
    font-bold text-text-heading mb-4\">\U0001F4AD pypeaday/whose-turn-is-it: Simple
    uv webapp to determine order...</h1>\n    <div class=\"flex items-center text-sm
  ...
  partial: "<article class=\"w-full overflow-x-hidden\">\n<section class=\"post-header
    ...
    mb-4\">\U0001F4AD pypeaday/whose-turn-is-it: Simple uv webapp to determine order...</h1>\n
  ...
  raw.md: "\n<a href=\"https://github.com/pypeaday/whose-turn-is-it\">\n    <img\n
    ...
    pray together as a family every night, but every single flipping night my daughter's
    fight about the order we go in... well, NO MORE!\n\nI built a simple uv fastapi
    app that randomly sorts a list from an environment var `PLAYERS` and presents
    it in the web page at `/generate`.\n\nSuper easy `uv run` at home...\n\nI love
    that with enough knowledge, or the right kind of knowledge, you can build like
...
published: true
slug: thoughts-709
title: "\U0001F4AD pypeaday/whose-turn-is-it: Simple uv webapp to determine order..."
