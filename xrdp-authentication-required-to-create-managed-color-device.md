...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Xrdp-Authentication-Required-To-Create-Managed-Color-Device</title>\n<meta
    ...
    lg:prose-xl max-w-none mx-auto mt-8\">\n        <p>I just need to RDP into an
    Ubuntu box via Remmina and everytime I login I have\nto authenticate to create
    a color managed device... which I don't even know\nwhat that is!</p>\n<p>To fix
