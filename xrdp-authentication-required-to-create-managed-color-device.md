...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Xrdp-Authentication-Required-To-Create-Managed-Color-Device</title>\n<meta
    ...
    alt=\"Xrdp-Authentication-Required-To-Create-Managed-Color-Device cover image\"
    ...
    mb-4\">Xrdp-Authentication-Required-To-Create-Managed-Color-Device</h1>\n    <div
    ...
    lg:prose-xl mx-auto mt-8\">\n        <p>I just need to RDP into an Ubuntu box
    via Remmina and everytime I login I have\nto authenticate to create a color managed
    device... which I don't even know\nwhat that is!</p>\n<p>To fix it?</p>\n<p><code>vim
    /etc/polkit-1/localauthority.conf.d/02-allow-colord.conf</code></p>\n<pre class='wrapper'>\n\n<div
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Xrdp-Authentication-Required-To-Create-Managed-Color-Device</title>\n<meta
    ...
    font-bold text-text-heading mb-4\">Xrdp-Authentication-Required-To-Create-Managed-Color-Device</h1>\n
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n    <div class=\"mt-8 mb-8
    md:-mx-4\">\n        <img src=\"/media/xrdp-authentication-required-to-create-managed-color-device.png\"
    alt=\"Xrdp-Authentication-Required-To-Create-Managed-Color-Device cover image\"
    class=\"w-full object-cover rounded-lg shadow-2xl border-4 border-white dark:border-gray-600\"
    style=\"max-height: 400px;\">\n    </div>\n<section class=\"post-header mb-8\">\n
    \   <h1 id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading
