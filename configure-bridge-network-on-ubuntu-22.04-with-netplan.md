...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Configure bridge
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Configure
    bridge network on Ubuntu 22.04 with Netplan</h1>\n    <div class=\"flex items-center
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Configure bridge network
    ...
    font-bold text-text-heading mb-4\">Configure bridge network on Ubuntu 22.04 with
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Configure bridge network on Ubuntu 22.04 with Netplan</h1>\n    <div class=\"flex
