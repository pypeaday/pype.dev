...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Recovering from
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Recovering
    from zpool corruption when you're short a drive</h1>\n    <div class=\"flex items-center
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Recovering from zpool
    ...
    font-bold text-text-heading mb-4\">Recovering from zpool corruption when you're
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Recovering from zpool corruption when you're short a drive</h1>\n    <div
