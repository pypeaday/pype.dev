...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Use non-standard
    ...
    non-standard named ssh keys with github | Nic Payne\" />\n<meta property=\"og:description\"
    content=\"I was getting `(publickey denied)` when trying to push to GH using ssh.
    When I\ntested the connection I saw that a bunch of keys in ``~/.ssh/ were being\nattempte\"
    />\n<meta property=\"og:image\" content=\"https://cdn.statically.io/gh/pypeaday/pype.dev/main/pages/media/og-02.png\"
    />\n<meta property=\"og:url\" content=\"https://pype.devuse-non-standard-named-ssh-keys-with-github\"
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    mt-8\">\n        <p>I was getting <code>(publickey denied)</code> when trying
    to push to GH using ssh. When I\ntested the connection I saw that a bunch of keys
