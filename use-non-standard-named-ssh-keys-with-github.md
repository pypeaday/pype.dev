...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Use non-standard
    ...
    md:text-5xl font-bold text-text-heading mb-4\">Use non-standard named ssh keys
    ...
    mx-auto mt-8\">\n        <p>I was getting <code>(publickey denied)</code> when
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Use non-standard named
    ...
    font-bold text-text-heading mb-4\">Use non-standard named ssh keys with github</h1>\n
  ...
  partial: "<article class='w-full'>\n<section class=\"post-header mb-8\">\n    <h1
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Use
    non-standard named ssh keys with github</h1>\n    <div class=\"flex items-center
    ...
    lg:prose-xl max-w-none mx-auto mt-8\">\n        <p>I was getting <code>(publickey
    denied)</code> when trying to push to GH using ssh. When I\ntested the connection
    I saw that a bunch of keys in ``~/.ssh/ were being\nattempted</p>\n<pre class='wrapper'>\n\n<div
    class='copy-wrapper'>\n\n<button class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
    version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
    x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
    0 0 115.77 122.88\" xml:space=\"preserve\"><style type=\"text/css\">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path
