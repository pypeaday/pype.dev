---
content: "I was getting `(publickey denied)` when trying to push to GH using ssh.
...
description: 'I was getting `(publickey denied)` when trying to push to GH using ssh.
  ...
  attempte'
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Use non-standard
    named ssh keys with github</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\"
    ...
    property=\"og:title\" content=\"Use non-standard named ssh keys with github |
    Nic Payne\" />\n<meta property=\"og:image\" content=\"https://cdn.statically.io/gh/pypeaday/pype.dev/main/pages/media/og-02.png\"
    />\n<meta property=\"og:url\" content=\"https://pype.dev/use-non-standard-named-ssh-keys-with-github\"
    />\n<meta name=\"twitter:card\" content=\"summary_large_image\">\n<meta name=\"twitter:title\"
    content=\"Use non-standard named ssh keys with github | Nic Payne\" />\n<meta
    name=\"twitter:description\" content=\"I was getting `(publickey denied)` when
    trying to push to GH using ssh. When I\ntested the connection I saw that a bunch
    of keys in ``~/.ssh/ were being\nattempte\" />\n<meta name=\"twitter:image\" content=\"https://cdn.statically.io/gh/pypeaday/pype.dev/main/pages/media/og-02.png\"
    ...
    \           <span class=\"site-terminal__dir\">~/use-non-standard-named-ssh-keys-with-github</span>\n
    ...
    mb-4 post-title-large\">Use non-standard named ssh keys with github</h1>\n    <div
    ...
    prose dark:prose-invert\">\n            <p>I was getting <code>(publickey denied)</code>
    when trying to push to GH using ssh. When I\ntested the connection I saw that
    a bunch of keys in ``~/.ssh/ were being\nattempted</p>\n<pre class='wrapper'>\n\n<div
    ...
    ssh git@github.com -vv</span>\n\n<span class=\"go\">...</span>\n\n<span class=\"go\">debug1:
    Will attempt key: /home/nic/.ssh/id_rsa </span>\n<span class=\"go\">debug1: Will
    attempt key: /home/nic/.ssh/id_ecdsa </span>\n<span class=\"go\">debug1: Will
    ...
    Will attempt key: /home/nic/.ssh/id_xmss </span>\n<span class=\"go\">debug1: Will
    attempt key: /home/nic/.ssh/id_dsa </span>\n\n<span class=\"go\">...</span>\n\n<span
    class=\"go\">debug1: No more authentication methods to try.</span>\n<span class=\"go\">git@github.com:
    Permission denied (publickey).</span>\n</pre></div>\n\n</pre>\n\n<p>None of those
    were the key I setup with GH. So I added an entry\ninto <code>~/.ssh/config</code>:</p>\n<pre
    ...
    yes\nIdentitiesOnly yes \n</pre></div>\n\n</pre>\n\n\n        </section>\n    </article>\n</section>
    \       </div>\n    </main>\n</div>\n     </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Use non-standard named
    ssh keys with github</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\"
    content=\"width=device-width, initial-scale=1\" />\n<meta name=\"description\"
    content=\"I was getting `(publickey denied)` when trying to push to GH using ssh.
    When I\ntested the connection I saw that a bunch of keys in ``~/.ssh/ were being\nattempte\"
    />\n <link href=\"/favicon.ico\" rel=\"icon\" type=\"image/png\" />\n<link rel=\"preconnect\"
  ...
  partial: "<section class=\"post-terminal  post-terminal--til \">\n\n    <article
    ...
    md:text-7xl font-extrabold gradient-text mb-4 post-title-large\">Use non-standard
    named ssh keys with github</h1>\n    <div class=\"flex items-center text-sm text-text-main/80
    mb-6\">\n        <time datetime=\"2023-01-03\">\n            January 03, 2023\n
  ...
  protected-post: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Use non-standard
    ...
    <code>(publickey denied)</code> when trying to push to GH using ssh. When I\ntested
    the connection I saw that a bunch of keys in ``~/.ssh/ were being\nattempted</p>\n<pre
    class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button class='copy' title='copy
    code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
    version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
    x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
  ...
  raw.md: "---\ndate: 2023-01-03 08:34:50\ntemplateKey: til\ntitle: Use non-standard
    named ssh keys with github\npublished: True\ntags:\n  - linux\n  - cli\n  - tech\n
    \ - til\n\n---\n\nI was getting `(publickey denied)` when trying to push to GH
    using ssh. When I\ntested the connection I saw that a bunch of keys in ``~/.ssh/
    were being\nattempted\n\n```console\n\u2717 ssh git@github.com -vv\n\n...\n\ndebug1:
    Will attempt key: /home/nic/.ssh/id_rsa \ndebug1: Will attempt key: /home/nic/.ssh/id_ecdsa
    \ndebug1: Will attempt key: /home/nic/.ssh/id_ecdsa_sk \ndebug1: Will attempt
    key: /home/nic/.ssh/id_ed25519 \ndebug1: Will attempt key: /home/nic/.ssh/id_ed25519_sk
    \ndebug1: Will attempt key: /home/nic/.ssh/id_xmss \ndebug1: Will attempt key:
    /home/nic/.ssh/id_dsa \n\n...\n\ndebug1: No more authentication methods to try.\ngit@github.com:
    Permission denied (publickey).\n\n```\n\nNone of those were the key I setup with
    GH. So I added an entry\ninto `~/.ssh/config`:\n\n```text\nHost\ngithub.com\nUser
    git\nPort 22\nHostname github.com\nIdentityFile ~/.ssh/my_custom_github_key\nTCPKeepAlive
    yes\nIdentitiesOnly yes \n\n```\n\n"
published: true
