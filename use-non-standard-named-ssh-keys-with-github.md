...
description: 'I was getting `(publickey denied)` when trying to push to GH using ssh.
  ...
  attempte'
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>Use non-standard named ssh keys
    with github</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width,
    initial-scale=1\" />\n<meta name=\"description\" content=\"I was getting `(publickey
    denied)` when trying to push to GH using ssh. When I\ntested the connection I
    saw that a bunch of keys in ``~/.ssh/ were being\nattempte\" />\n <link href=\"/favicon.ico\"
    rel=\"icon\" type=\"image/png\" />\n\n<link rel=\"stylesheet\" href=\"/post.css\"
    />\n<link rel=\"stylesheet\" href=\"/app.css\" />\n<script src=\"/theme.js\"></script>\n\n\n
    \       <meta property=\"og:author_email\" content=\"nic@pype.dev\" />\n\n    <head>\n
    \       <script src=\"https://unpkg.com/@tailwindcss/browser@4\"></script>\n<title>Use
    non-standard named ssh keys with github</title>\n<meta charset=\"UTF-8\" />\n<meta
    ...
    class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n        Use
    non-standard named ssh keys with github\n    </h1>\n</section>    <section class=\"body\">\n
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>Use non-standard named ssh keys
    ...
    \   <style>\n        section {\n            font-size: 200%;\n        }\n\n\n
    \       .edit {\n            display: none;\n        }\n    </style>\n<section
    class=\"title\">\n    <h1 id=\"title\">\n        Use non-standard named ssh keys
    with github\n    </h1>\n</section></article>\n     </body>\n</html>"
  ...
  raw.md: "---\ndate: 2023-01-03 08:34:50\ntemplateKey: til\ntitle: Use non-standard
    ...
    was getting `(publickey denied)` when trying to push to GH using ssh. When I\ntested
    ...
    denied (publickey).\n\n```\n\nNone of those were the key I setup with GH. So I
    added an entry\ninto `~/.ssh/config`:\n\n```text\nHost\ngithub.com\nUser git\nPort
    22\nHostname github.com\nIdentityFile ~/.ssh/my_custom_github_key\nTCPKeepAlive
    yes\nIdentitiesOnly yes \n\n```\n\n"
published: true
