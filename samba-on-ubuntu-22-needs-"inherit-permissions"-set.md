...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Samba on Ubuntu
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Samba
    on Ubuntu 22 needs \"inherit permissions\" set</h1>\n    <div class=\"flex items-center
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Samba on Ubuntu 22
    ...
    font-bold text-text-heading mb-4\">Samba on Ubuntu 22 needs \"inherit permissions\"
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Samba on Ubuntu 22 needs \"inherit permissions\" set</h1>\n    <div class=\"flex
