...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>Dynamic-Form-Values-With-Jinja-And-Fastapi</title>\n<meta
    ...
    on a self-hostable wish list app using FastAPI so we can\nfinally drop Amazon
    forever. (The lists funcionality has been super handy for\nsharing holiday gift
    ideas with the famj!)</p>\n<h1 id=\"fastapi\">FastAPI <a class=\"header-anchor\"
  ...
  partial: "<article class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n
    \       Dynamic-Form-Values-With-Jinja-And-Fastapi\n    </h1>\n</section>    <section
    class=\"body\">\n        <p>I'm currently working on a self-hostable wish list
    app using FastAPI so we can\nfinally drop Amazon forever. (The lists funcionality
    has been super handy for\nsharing holiday gift ideas with the famj!)</p>\n<h1
