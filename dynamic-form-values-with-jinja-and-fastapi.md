...
article_html: "<p>I'm currently working on a self-hostable wish list app using FastAPI
  ...
  .8rem;\n    }\n    .prevnext-title {\n      color: var(--prevnext-color-text);\n
  \     font-size: 1rem;\n    }\n    .prevnext-text {\n      max-width: 30vw;\n    }\n
  \   </style>\n\n    <a class='prev' href='/self-hosted-docker-registry-with-proxy-pull-through'>\n\n\n
  ...
  class='next' href='/kanboard-to-keep-me-focused-on-my-own-ideas'>\n\n        <div
  class='prevnext-text'>\n            <p class='prevnext-subtitle'>next</p>\n            <p
  class='prevnext-title'>Kanboard to keep me focused on my own ideas</p>\n        </div>\n
  \       <svg width=\"50px\" height=\"50px\" viewbox=\"0 0 24 24\" fill=\"none\"
...
long_description: I FastAPI is an amazing framework for quickly building APIs with
  ...
  a The way to pas
now: 2024-10-12 11:09:11.872390
...
<div class='prevnext'>
    ...
    <a class='next' href='/kanboard-to-keep-me-focused-on-my-own-ideas'>
