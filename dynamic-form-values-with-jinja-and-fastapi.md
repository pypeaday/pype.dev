...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Dynamic-Form-Values-With-Jinja-And-Fastapi</title>\n<meta
    ...
    self-hostable wish list app using FastAPI so we can\nfinally drop Amazon forever.
    (The lists funcionality has been super handy for\nsharing holiday gift ideas with
    the famj!)</p>\n<h1 id=\"fastapi\">FastAPI <a class=\"header-anchor\" href=\"#fastapi\"><svg
