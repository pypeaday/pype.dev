...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Git repo specific
    ...
    repo specific SSH Key! | Nic Payne\" />\n<meta property=\"og:description\" content=\"git
    config --add --local core.sshCommand &#x27;ssh -i &lt;&lt;&lt;PATH_TO_SSH_KEY&gt;&gt;&gt;&#x27;\"
    />\n<meta property=\"og:image\" content=\"https://cdn.statically.io/gh/pypeaday/pype.dev/main/pages/media/og-02.png\"
    />\n<meta property=\"og:url\" content=\"https://pype.devgit-repo-specific-ssh-key\"
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    dark:prose-invert lg:prose-xl mx-auto mt-8\">\n        <p>git config --add --local
    core.sshCommand 'ssh -i &lt;&lt;&lt;PATH_TO_SSH_KEY&gt;&gt;&gt;'</p>\n\n    </section>\n</article>
    \       </div>\n    </main>\n\n</div>\n     </body>\n</html>"
