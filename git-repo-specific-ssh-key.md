---
content: git config --add --local core.sshCommand 'ssh -i <<<PATH_TO_SSH_KEY>>>'
date: 2024-01-04
description: git config --add --local core.sshCommand &#x27;ssh -i &lt;&lt;&lt;PATH_TO_SSH_KEY&gt;&gt;&gt;&#x27;
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Git repo specific
    SSH Key!</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width,
    initial-scale=1\" />\n<meta name=\"description\" content=\"git config --add --local
    core.sshCommand &#x27;ssh -i &lt;&lt;&lt;PATH_TO_SSH_KEY&gt;&gt;&gt;&#x27;\" />\n
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Git
    repo specific SSH Key!</h1>\n    <div class=\"flex items-center text-sm text-text-main/80
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Git repo specific SSH
    ...
    font-bold text-text-heading mb-4\">Git repo specific SSH Key!</h1>\n    <div class=\"flex
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Git repo specific SSH Key!</h1>\n    <div class=\"flex items-center text-sm
    ...
    lg:prose-xl mx-auto mt-8\">\n        <p>git config --add --local core.sshCommand
    'ssh -i &lt;&lt;&lt;PATH_TO_SSH_KEY&gt;&gt;&gt;'</p>\n\n    </section>\n</article>"
  raw.md: "---\ndate: 2024-01-04 15:42:15\ntemplateKey: til\ntitle: Git repo specific
    SSH Key!\npublished: True\ntags:\n  - cli\n  - git\n  - til\n\n---\n\ngit config
    --add --local core.sshCommand 'ssh -i <<<PATH_TO_SSH_KEY>>>'\n"
published: true
slug: git-repo-specific-ssh-key
