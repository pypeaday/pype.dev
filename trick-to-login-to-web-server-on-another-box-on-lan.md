...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Trick to login to
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Trick
    to login to web server on another box on lan</h1>\n    <div class=\"flex items-center
    ...
    lg:prose-xl mx-auto mt-8\">\n        <p>TODO: change title - add --listen or --host
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Trick to login to web
    ...
    font-bold text-text-heading mb-4\">Trick to login to web server on another box
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Trick to login to web server on another box on lan</h1>\n    <div class=\"flex
