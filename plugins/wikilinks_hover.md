---
content: "---\n\nNone\n\n---\n\n!!! function\n    <h2 id=\"post_render\" class=\"admonition-title\"
  ...
  \       \"Hook to replace youtubes on images.waylonwalker.com with mp4's if they
  ...
  \                       )\n                else:\n                    post.html
  = do_hover_links(cache, markata, post.html, post.slug)\n    ```"
date: 2025-06-27
description: "None !!! function\n    &lt;h2 id=&quot;post_render&quot; class=&quot;admonition-title&quot;
  style=&quot;margin: 0; padding: .5rem 1rem;&quot;&gt;post_render &lt;"
html:
  index: "<html lang=\"en\">\n    <head>\n<title>wikilinks_hover.py</title>\n<meta
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">wikilinks_hover.py</h1>\n
    ...
    style=\"margin: 0; padding: .5rem 1rem;\">post_render <em class=\"small\">function</em></h2>\n<p>Hook
    to replace youtubes on <a href=\"http://images.waylonwalker.com\">images.waylonwalker.com</a>
    with mp4's if they exist</p>\n</div>\n<div class=\"admonition source is-collapsible
    ...
    to replace youtubes on images.waylonwalker.com with mp4's if they exist\"</span>\n\n
    \   <span class=\"nb\">print</span><span class=\"p\">(</span><span class=\"s2\">\"looking
    for wikilinks\"</span><span class=\"p\">)</span>\n    <span class=\"k\">with</span>
    ...
    class=\"s2\">\"No html for post:\"</span><span class=\"p\">,</span> <span class=\"n\">post</span><span
    class=\"o\">.</span><span class=\"n\">slug</span><span class=\"p\">)</span>\n
    \               <span class=\"k\">continue</span>\n\n            <span class=\"k\">if</span>
    <span class=\"nb\">isinstance</span><span class=\"p\">(</span><span class=\"n\">post</span><span
    class=\"o\">.</span><span class=\"n\">html</span><span class=\"p\">,</span> <span
    class=\"nb\">dict</span><span class=\"p\">):</span>\n                <span class=\"k\">for</span>
    <span class=\"n\">key</span><span class=\"p\">,</span> <span class=\"n\">post_html</span>
    ...
    class=\"n\">do_hover_links</span><span class=\"p\">(</span>\n                        <span
    class=\"n\">cache</span><span class=\"p\">,</span> <span class=\"n\">markata</span><span
    class=\"p\">,</span> <span class=\"n\">post_html</span><span class=\"p\">,</span>
    ...
    class=\"n\">html</span> <span class=\"o\">=</span> <span class=\"n\">do_hover_links</span><span
  ...
  og: "<html lang=\"en\">\n    <head>\n<title>wikilinks_hover.py</title>\n<meta charset=\"UTF-8\">\n<meta
    ...
    font-bold text-text-heading mb-4\">wikilinks_hover.py</h1>\n    <div class=\"flex
  ...
  partial: "<article class=\"w-full overflow-x-hidden\">\n<section class=\"post-header
    ...
    class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">post_render
    <em class=\"small\">function</em></h2>\n<p>Hook to replace youtubes on <a href=\"http://images.waylonwalker.com\">images.waylonwalker.com</a>
    with mp4's if they exist</p>\n</div>\n<div class=\"admonition source is-collapsible
    collapsible-open\">\n<p class=\"admonition-title\">post_render <em class=\"small\">source</em></p>\n<pre
    class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button class=\"copy\" title=\"copy
    code to clipboard\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
  ...
  raw.md: ''
published: false
slug: plugins/wikilinks-hover
title: wikilinks_hover.py
