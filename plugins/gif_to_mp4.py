...
def is_valid_gif(gif: "Tag") -> bool:
    "checks the src of the image, must be from images.pype.dev and a .gif"
    src = gif.attrs["src"]
    return src.startswith("https://images.pype.dev") and src.endswith(".gif")
...
def post_render(markata):
    "Hook to replace gifs on images.pype.dev with mp4's if they exist"
