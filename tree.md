...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Tree</title>\n<meta
    ...
    src=\"/media/tree.png\" alt=\"Tree cover image\" class=\"w-full object-cover rounded-lg
    shadow-2xl border-4 border-white dark:border-gray-600\" style=\"max-height: 400px;\">\n
    \   </div>\n<section class=\"post-header mb-8\">\n    <h1 id=\"title\" class=\"text-4xl
    md:text-5xl font-bold text-text-heading mb-4\">Tree</h1>\n    <div class=\"flex
    ...
    lg:prose-xl mx-auto mt-8\">\n        <p>I wanted a quick way to generate an <code>index.html</code>
    for a directory of html files that grows by 1 or 2 files a week.\nI don't know
    any html (the files are exports from my <a href=\"/tiddly-wiki\">tiddlywiki</a>)...</p>\n<p><code>tree</code>
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Tree</title>\n<meta
    ...
    font-bold text-text-heading mb-4\">Tree</h1>\n    <div class=\"flex items-center
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n    <div class=\"mt-8 mb-8
    md:-mx-4\">\n        <img src=\"/media/tree.png\" alt=\"Tree cover image\" class=\"w-full
