...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Setup KVM to boot
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Setup
    KVM to boot from local PXE server</h1>\n    <div class=\"flex items-center text-sm
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Setup KVM to boot from
    ...
    font-bold text-text-heading mb-4\">Setup KVM to boot from local PXE server</h1>\n
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Setup KVM to boot from local PXE server</h1>\n    <div class=\"flex items-center
