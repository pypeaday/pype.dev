...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Setup KVM to boot
    ...
    md:text-5xl font-bold text-text-heading mb-4\">Setup KVM to boot from local PXE
  ...
  partial: "<article class='w-full'>\n<section class=\"post-header mb-8\">\n    <h1
    ...
    lg:prose-xl max-w-none mx-auto mt-8\">\n        <p>Assuming you have a PXE server
    running you only need small edits to the virt-manager config</p>\n\n    </section>\n</article>"
