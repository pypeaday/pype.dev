...
date: 2024-09-17
description: Add from url?? ADD http://example.com/cars.csv /tmp/cars.csv Unpack automatically!?
  (.tar, .tar.gz, .tgz, .bz2, .tbz2, .txz, .zip) ADD myapp.tar.gz /opt/myapp/
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>docker-remote-add</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"Add from url?? ADD http://example.com/cars.csv
    /tmp/cars.csv Unpack automatically!? (.tar, .tar.gz, .tgz, .bz2, .tbz2, .txz,
    .zip) ADD myapp.tar.gz /opt/myapp/\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
    ...
    property=\"og:title\" content=\"docker-remote-add | Nic Payne\" />\n<meta property=\"og:image\"
    content=\"https://cdn.statically.io/gh/pypeaday/pype.dev/main/pages/media/og-02.png\"
    />\n<meta property=\"og:url\" content=\"https://pype.dev/docker-remote-add\" />\n<meta
    name=\"twitter:card\" content=\"summary_large_image\">\n<meta name=\"twitter:title\"
    content=\"docker-remote-add | Nic Payne\" />\n<meta name=\"twitter:description\"
    content=\"Add from url?? ADD http://example.com/cars.csv /tmp/cars.csv Unpack
    automatically!? (.tar, .tar.gz, .tgz, .bz2, .tbz2, .txz, .zip) ADD myapp.tar.gz
    ...
    \           <span class=\"site-terminal__dir\">~/docker-remote-add</span>\n        </div>\n
    ...
    mb-4 post-title-large\">docker-remote-add</h1>\n    <div class=\"flex items-center
    ...
    prose dark:prose-invert\">\n            <p>Add from url??</p>\n<p>ADD <a href=\"http://example.com/cars.csv\">http://example.com/cars.csv</a>
    /tmp/cars.csv</p>\n<p>Unpack automatically!? (.tar, .tar.gz, .tgz, .bz2, .tbz2,
  ...
  partial: "<section class=\"post-terminal  post-terminal--til \">\n\n    <article
    ...
    md:text-7xl font-extrabold gradient-text mb-4 post-title-large\">docker-remote-add</h1>\n
  ...
  protected-post: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>docker-remote-add</title>\n<meta
    ...
    <a href=\"http://example.com/cars.csv\">http://example.com/cars.csv</a> /tmp/cars.csv</p>\n<p>Unpack
    automatically!? (.tar, .tar.gz, .tgz, .bz2, .tbz2, .txz, .zip)</p>\n<p>ADD myapp.tar.gz
    /opt/myapp/</p>\n\n        </div>\n    </main>\n</div>\n     </body>\n</html>"
  raw.md: "---\ndate: 2024-09-17 06:19:00\ntemplateKey: til\ntitle: docker-remote-add\npublished:
    True\ntags:\n  - homelab\n  - linux\n  - tech\n  - til\n\n---\n\nAdd from url??\n\nADD
    http://example.com/cars.csv /tmp/cars.csv\n\nUnpack automatically!? (.tar, .tar.gz,
    .tgz, .bz2, .tbz2, .txz, .zip)\n\nADD myapp.tar.gz /opt/myapp/\n"
published: true
slug: docker-remote-add
title: docker-remote-add
