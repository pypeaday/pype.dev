...
content: "Started on [[2025-07-16-notes]] using this page for my \"don't lose sight
  ...
  [[should-data-models-be-fat]]\n\n## DH\n\n- I need to dedicate an hour or 2 to the
  terraform stuff...\n\n  - cloudflare pages + config\n  - namecheap DNS\n  - cloudflare
  tunnel\n  - cloudflare DNS\n  - I've had a couple bespoke modules that are hot garbage,
  I think I can have one stack instead of one per domain... need to explore that\n\n##
...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Now</title>\n<meta
    ...
    id=\"dh\">DH <a class=\"header-anchor\" href=\"#dh\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<ul>\n<li>\n<p>I need to
    dedicate an hour or 2 to the terraform stuff...</p>\n<ul>\n<li>cloudflare pages
    + config</li>\n<li>namecheap DNS</li>\n<li>cloudflare tunnel</li>\n<li>cloudflare
    DNS</li>\n<li>I've had a couple bespoke modules that are hot garbage, I think
    I can have one stack instead of one per domain... need to explore that</li>\n</ul>\n</li>\n</ul>\n<h2
  ...
  raw.md: "---\ndate: 2025-06-13 20:58:00\ntemplateKey: slashPage\ntitle: Now\npublished:
    ...
    for example. I archived it but there's no point in keeping it around I think\n\n##
    Hot\n\n> NOTE: check the pages for updates to each project\n\n- [[soonish]]\n\n-
    [[should-data-models-be-fat]]\n\n## DH\n\n- I need to dedicate an hour or 2 to
    the terraform stuff...\n\n  - cloudflare pages + config\n  - namecheap DNS\n  -
    cloudflare tunnel\n  - cloudflare DNS\n  - I've had a couple bespoke modules that
    are hot garbage, I think I can have one stack instead of one per domain... need
    to explore that\n\n## Runescape\n\n- [x] [Monkey Madness 1](https://oldschool.runescape.wiki/w/Monkey_Madness_I)\n\n
    \ - post on runelite plugins again\n  - safespot the gorillas in the temple\n
    \   ![20251130112234_945c685a.png](https://cdn.statically.io/gh/pypeaday/images.pype.dev/main/blog-media/20251130112234_945c685a.png)\n
    \   ![20251130122758_a8f58b1b.png](https://cdn.statically.io/gh/pypeaday/images.pype.dev/main/blog-media/20251130122758_a8f58b1b.png)\n\n-
...
- I need to dedicate an hour or 2 to the terraform stuff...

  - cloudflare pages + config
  - namecheap DNS
  - cloudflare tunnel
  - cloudflare DNS
  - I've had a couple bespoke modules that are hot garbage, I think I can have one stack instead of one per domain... need to explore that
