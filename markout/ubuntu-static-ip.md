...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Ubuntu-Static-Ip</title>\n<meta
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    gradient-text mb-4 post-title-large\">Ubuntu-Static-Ip</h1>\n    <div class=\"flex
    ...
    dark:prose-invert mx-auto mt-8\">\n        <p>Sometimes I need to manually set
    a static IP of a Linux machine. I generally run the latest version of Ubuntu server
