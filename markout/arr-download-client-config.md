---
content: 'TIL that when setting up download clients for
...
date: 2022-05-28
description: 'TIL that when setting up download clients for

  radarr/sonarr/lidarr/readarr/bazarr/prowlarr that you can utilize internal DNS

  and instead of hardcoding an IP add'
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>arr client config</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"TIL that when setting up download clients
    for\nradarr/sonarr/lidarr/readarr/bazarr/prowlarr that you can utilize internal
    ...
    property=\"og:title\" content=\"arr client config | Nic Payne\" />\n<meta property=\"og:image\"
    content=\"https://cdn.statically.io/gh/pypeaday/pype.dev/main/pages/media/og-02.png\"
    />\n<meta property=\"og:url\" content=\"https://pype.dev/arr-download-client-config\"
    />\n<meta name=\"twitter:card\" content=\"summary_large_image\">\n<meta name=\"twitter:title\"
    content=\"arr client config | Nic Payne\" />\n<meta name=\"twitter:description\"
    ...
    \           <span class=\"site-terminal__dir\">~/arr-download-client-config</span>\n
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    gradient-text mb-4 post-title-large\">arr client config</h1>\n    <div class=\"flex
    ...
    dark:prose-invert mx-auto mt-8\">\n        <p>TIL that when setting up download
    clients for\nradarr/sonarr/lidarr/readarr/bazarr/prowlarr that you can utilize
    internal DNS\nand instead of hardcoding an IP address of your download client
    server, can use\njust the CNAME record (ie. instead of 172.10.14.13 I can use\n<a
    href=\"http://transmission.mydomain.com\">transmission.mydomain.com</a>... notice
    the lact of http(s)://... adding that won't\nallow the connection to work/</p>\n<p>Furthermore,
    you can use internal DNS to lookup the domain, not the subdomain,\nand expose
    the port, like <code>mydomain.com:7878</code> for sonarr. This was simpler to\nmaintain
    because I don't change which ports an application exposes or utilizes\nhardly
    ever, plus I don't need to maintain CNAME records for every service!</p>\n\n    </section>\n</article>
    \       </div>\n    </main>\n\n</div>\n     </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>arr client config</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"TIL that when setting up download clients
    ...
    mb-4 post-title-large\">arr client config</h1>\n    <div class=\"flex items-center
  ...
  protected-post: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>arr client
    ...
    initial-scale=1\" />\n<meta name=\"description\" content=\"TIL that when setting
    up download clients for\nradarr/sonarr/lidarr/readarr/bazarr/prowlarr that you
    can utilize internal DNS\nand instead of hardcoding an IP add\" />\n <link href=\"/favicon.ico\"
    ...
    setting up download clients for\nradarr/sonarr/lidarr/readarr/bazarr/prowlarr
    that you can utilize internal DNS\nand instead of hardcoding an IP address of
    your download client server, can use\njust the CNAME record (ie. instead of 172.10.14.13
    I can use\n<a href=\"http://transmission.mydomain.com\">transmission.mydomain.com</a>...
    notice the lact of http(s)://... adding that won't\nallow the connection to work/</p>\n<p>Furthermore,
    you can use internal DNS to lookup the domain, not the subdomain,\nand expose
    the port, like <code>mydomain.com:7878</code> for sonarr. This was simpler to\nmaintain
    because I don't change which ports an application exposes or utilizes\nhardly
    ever, plus I don't need to maintain CNAME records for every service!</p>\n\n        </div>\n
  ...
  raw.md: "---\ndate: 2022-05-28 13:29:28\ntemplateKey: til\ntitle: arr client config\npublished:
    True\ntags:\n  - homelab\n  - tech\n  - til\n\n---\n\nTIL that when setting up
    download clients for\nradarr/sonarr/lidarr/readarr/bazarr/prowlarr that you can
    utilize internal DNS\nand instead of hardcoding an IP address of your download
    client server, can use\njust the CNAME record (ie. instead of 172.10.14.13 I can
    use\ntransmission.mydomain.com... notice the lact of http(s)://... adding that
    won't\nallow the connection to work/\n\nFurthermore, you can use internal DNS
    to lookup the domain, not the subdomain,\nand expose the port, like `mydomain.com:7878`
