...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>arr client config</title>\n<meta
    ...
    prose dark:prose-invert\">\n            <p>TIL that when setting up download clients
    for\nradarr/sonarr/lidarr/readarr/bazarr/prowlarr that you can utilize internal
    DNS\nand instead of hardcoding an IP address of your download client server, can
  ...
  partial: "<section class=\"post-terminal  post-terminal--til \">\n\n    <article
    ...
    md:text-7xl font-extrabold gradient-text mb-4 post-title-large\">arr client config</h1>\n
    ...
    that when setting up download clients for\nradarr/sonarr/lidarr/readarr/bazarr/prowlarr
