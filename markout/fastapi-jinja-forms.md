...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Forms with FastAPI
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    gradient-text mb-4 post-title-large\">Forms with FastAPI and Jinja</h1>\n    <div
    ...
    dark:prose-invert mx-auto mt-8\">\n        <p>I just started using FastAPI for
    a home project and needed to pass back a\ndynamic number of values from a form
    rendered with jinja...</p>\n<h1 id=\"dynamic-values\">Dynamic Values <a class=\"header-anchor\"
