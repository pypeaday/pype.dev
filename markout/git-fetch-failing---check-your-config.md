...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Git fetch failing
    ...
    property=\"og:title\" content=\"Git fetch failing - check your config | Nic Payne\"
    ...
    \           <span class=\"site-terminal__dir\">~/git-fetch-failing-check-your-config</span>\n
  ...
  partial: "<section class=\"post-terminal  post-terminal--til \">\n\n    <article
    ...
    md:text-7xl font-extrabold gradient-text mb-4 post-title-large\">Git fetch failing
    - check your config</h1>\n    <div class=\"flex items-center text-sm text-text-main/80
    mb-6\">\n        <time datetime=\"2024-04-18\">\n            April 18, 2024\n
