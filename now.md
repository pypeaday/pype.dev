...
content: "Started on [[2025-07-16-notes]] using this page for my \"don't lose sight
  ...
  [[soonish]]\n\n  - soonish event tracker\n  - update the project notes to notifiq,
  soonish is a specific sub-app now\n  - mindful getting built to launch with soonish\n\n-
  ...
  builds are broken in forgejo, maybe it's the runner image I'm using so might need
  to update it?\n  - having an image at home with just, zensical, uv, etc. built in
  already would be appropriate\n\n## Runescape\n\n- [x] [Monkey Madness 1](https://oldschool.runescape.wiki/w/Monkey_Madness_I)\n\n
...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Now</title>\n<meta
    ...
    class=\"wikilink\" href=\"/notifiq\">notifiq</a></p>\n</li>\n<li>\n<p><a class=\"wikilink\"
    href=\"/soonish\">soonish</a></p>\n<ul>\n<li>soonish event tracker</li>\n<li>update
    the project notes to notifiq, soonish is a specific sub-app now</li>\n<li>mindful
    getting built to launch with soonish</li>\n</ul>\n</li>\n<li>\n<p><a class=\"wikilink\"
    href=\"/mindful\">mindful</a></p>\n</li>\n<li>\n<p><a class=\"wikilink\" href=\"/quadtask\">quadtask</a></p>\n</li>\n<li>\n<p><a
    class=\"wikilink\" href=\"/qr-harbor\">qr-harbor</a></p>\n<ul>\n<li>josh's site
    ...
    my bot account. if I make the library public, then the push fails from forgejo
    with 401</p>\n</li>\n<li>\n<p>zensical builds are broken in forgejo, maybe it's
    the runner image I'm using so might need to update it?</p>\n<ul>\n<li>having an
    image at home with just, zensical, uv, etc. built in already would be appropriate</li>\n</ul>\n</li>\n</ul>\n<h2
  ...
  raw.md: "---\ndate: 2025-06-13 20:58:00\ntemplateKey: slashPage\ntitle: Now\npublished:
    ...
    if I make the library public, then the push fails from forgejo with 401\n\n- zensical
    builds are broken in forgejo, maybe it's the runner image I'm using so might need
    to update it?\n  - having an image at home with just, zensical, uv, etc. built
    in already would be appropriate\n\n## Runescape\n\n- [x] [Monkey Madness 1](https://oldschool.runescape.wiki/w/Monkey_Madness_I)\n\n
    \ - post on runelite plugins again\n  - safespot the gorillas in the temple\n
    \   ![20251130112234_945c685a.png](https://cdn.statically.io/gh/pypeaday/images.pype.dev/main/blog-media/20251130112234_945c685a.png)\n
    \   ![20251130122758_a8f58b1b.png](https://cdn.statically.io/gh/pypeaday/images.pype.dev/main/blog-media/20251130122758_a8f58b1b.png)\n\n-
    ## Migrating my homelab stuff to a mono repo\n\n  - [kanboard ticket for skm backup](https://kanboard.paynepride.com/?controller=TaskViewController&action=show&task_id=247&project_id=8)\n
...
- [[soonish]]
  ...
  - soonish event tracker
  - update the project notes to notifiq, soonish is a specific sub-app now
  - mindful getting built to launch with soonish
...
- zensical builds are broken in forgejo, maybe it's the runner image I'm using so might need to update it?
  - having an image at home with just, zensical, uv, etc. built in already would be appropriate
