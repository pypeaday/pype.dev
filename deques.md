...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Deques</title>\n<meta
    ...
    src=\"/media/deques.png\" alt=\"Deques cover image\" class=\"w-full object-cover
    rounded-lg shadow-2xl border-4 border-white dark:border-gray-600\" style=\"max-height:
    400px;\">\n    </div>\n<section class=\"post-header mb-8\">\n    <h1 id=\"title\"
    class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Deques</h1>\n
    ...
    a project to create a small system monitoring dashboard using the python <code>psutil</code>
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Deques</title>\n<meta
    ...
    font-bold text-text-heading mb-4\">Deques</h1>\n    <div class=\"flex items-center
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n    <div class=\"mt-8 mb-8
    md:-mx-4\">\n        <img src=\"/media/deques.png\" alt=\"Deques cover image\"
    ...
    lg:prose-xl mx-auto mt-8\">\n        <p>I am working on a project to create a
    small system monitoring dashboard using the python <code>psutil</code> library.</p>\n<p>The
