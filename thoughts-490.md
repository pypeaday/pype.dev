...
html:
  index: "<html lang=\"en\">\n    <head>\n<title>\U0001F4AD \U0001F3E1 Home | Open
    ...
    class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">\U0001F4AD \U0001F3E1
    ...
    href=\"https://pype.dev//tags/ai/\" class=\"inline-block bg-primary-light text-accent-cool
    text-xs font-medium px-3 py-1 rounded-full hover:bg-primary-light/80 transition-colors
    border border-accent-cool/20\">\n                #ai\n            </a>\n            <a
