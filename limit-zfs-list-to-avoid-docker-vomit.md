...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Limit zfs list to
    ...
    md:text-5xl font-bold text-text-heading mb-4\">Limit zfs list to avoid docker
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Limit zfs list to avoid
    ...
    font-bold text-text-heading mb-4\">Limit zfs list to avoid docker vomit</h1>\n
    \   <div class=\"flex items-center text-sm text-text-main/80 mb-6\">\n        <time
    datetime=\"2022-10-20\">\n            October 20, 2022\n        </time>\n    </div>\n
    \   <div class=\"flex flex-wrap gap-2\">\n            <a href=\"https://pype.dev//tags/zfs/\"
    class=\"inline-block bg-primary-light text-accent-cool text-xs font-medium px-3
  ...
  partial: "<article class='w-full'>\n<section class=\"post-header mb-8\">\n    <h1
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Limit
    zfs list to avoid docker vomit</h1>\n    <div class=\"flex items-center text-sm
    ...
    lg:prose-xl max-w-none mx-auto mt-8\">\n        <p>zfs list has a flag -r, but
    if you use zfs driver for docker then you'll get\nflooded with every docker volume
    in the world. zfs list -r -d N will limit the\ndept of the print out, so zfs list
