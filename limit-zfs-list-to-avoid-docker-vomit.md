...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Limit zfs list to
    ...
    zfs list to avoid docker vomit | Nic Payne\" />\n<meta property=\"og:description\"
    content=\"zfs list has a flag -r, but if you use zfs driver for docker then you&#x27;ll
    get\nflooded with every docker volume in the world. zfs list -r -d N will limit
    the\" />\n<meta property=\"og:image\" content=\"https://cdn.statically.io/gh/pypeaday/pype.dev/main/pages/media/og-02.png\"
    />\n<meta property=\"og:url\" content=\"https://pype.devlimit-zfs-list-to-avoid-docker-vomit\"
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    mt-8\">\n        <p>zfs list has a flag -r, but if you use zfs driver for docker
    then you'll get\nflooded with every docker volume in the world. zfs list -r -d
