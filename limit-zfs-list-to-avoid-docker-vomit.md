...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Limit zfs list to
    ...
    lg:prose-xl mx-auto mt-8\">\n        <p>zfs list has a flag -r, but if you use
    zfs driver for docker then you'll get\nflooded with every docker volume in the
    world. zfs list -r -d N will limit the\ndept of the print out, so zfs list -r
    -d 2 gives me tank, tank/encrypted,\ntank/encrypted/docker -&gt; but then I don't
    see all the continer volumes</p>\n\n    </section>\n</article>        </div>\n
    \   </main>\n\n</div>\n     </body>\n</html>"
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Limit zfs list to avoid docker vomit</h1>\n    <div class=\"flex items-center
