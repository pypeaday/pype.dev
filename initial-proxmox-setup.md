---
content: '1. `apt-get` by default wil go to the pve.enterprise repos so we need to
  point it to the non-enterprise ones.
  ...
  ```'
date: 2022-05-23
description: '`apt-get` by default wil go to the pve.enterprise repos so we need to
  point it to the non-enterprise ones.'
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Initial Proxmox
    Setup</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width,
    initial-scale=1\" />\n<meta name=\"description\" content=\"`apt-get` by default
    wil go to the pve.enterprise repos so we need to point it to the non-enterprise
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Initial
    ...
    prose dark:prose-invert lg:prose-xl mx-auto mt-8\">\n        <ol>\n<li><code>apt-get</code>
    by default wil go to the pve.enterprise repos so we need to point it to the non-enterprise
    ...
    \       \n<div class=\"highlight\"><pre><span></span>rm /etc/apt/sources.list.d/pve-enterprise.list\nvim
    /etc/apt/sources.list.d/pve-no-subscription.list\n# add deb http://download.proxmox.com/debian/pve
    buster pve-no-subscription\n</pre></div>\n\n</pre>\n\n\n    </section>\n</article>
    \       </div>\n    </main>\n\n</div>\n     </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Initial Proxmox Setup</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"`apt-get` by default wil go to the pve.enterprise
    repos so we need to point it to the non-enterprise ones.\" />\n <link href=\"/favicon.ico\"
    ...
    font-bold text-text-heading mb-4\">Initial Proxmox Setup</h1>\n    <div class=\"flex
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    lg:prose-xl mx-auto mt-8\">\n        <ol>\n<li><code>apt-get</code> by default
    wil go to the pve.enterprise repos so we need to point it to the non-enterprise
    ones.</li>\n</ol>\n<pre class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button
    class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
    version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  ...
  raw.md: "---\ndate: 2022-05-23 06:19:13\ntemplateKey: blog-post\ntitle: Initial
    Proxmox Setup\npublished: False\ntags:\n  - homelab\n  - tech\n  - linux\n\n---\n\n1.
    `apt-get` by default wil go to the pve.enterprise repos so we need to point it
    to the non-enterprise ones.\n```\nrm /etc/apt/sources.list.d/pve-enterprise.list\nvim
    /etc/apt/sources.list.d/pve-no-subscription.list\n# add deb http://download.proxmox.com/debian/pve
    buster pve-no-subscription\n```\n"
published: false
slug: initial-proxmox-setup
