...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>arr client config</title>\n<meta
    ...
    md:text-5xl font-bold text-text-heading mb-4\">arr client config</h1>\n    <div
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>arr client config</title>\n<meta
    ...
    font-bold text-text-heading mb-4\">arr client config</h1>\n    <div class=\"flex
  ...
  partial: "<article class='w-full'>\n<section class=\"post-header mb-8\">\n    <h1
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">arr
