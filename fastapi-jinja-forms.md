...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Forms with FastAPI
    ...
    class='w-full'>\n    <div class=\"mt-8 mb-8 -mx-8\">\n        <img src=\"/media/forms-with-fast-api-and-jinja.png\"
    alt=\"Forms with FastAPI and Jinja cover image\" class=\"w-full object-cover rounded-lg
    shadow-2xl border-4 border-white dark:border-gray-600\" style=\"max-height: 400px;\">\n
    \   </div>\n<section class=\"post-header mb-8\">\n    <h1 id=\"title\" class=\"text-4xl
    md:text-5xl font-bold text-text-heading mb-4\">Forms with FastAPI and Jinja</h1>\n
    ...
    started using FastAPI for a home project and needed to pass back a\ndynamic number
    of values from a form rendered with jinja...</p>\n<h1 id=\"dynamic-values\">Dynamic
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Forms with FastAPI
    ...
    font-bold text-text-heading mb-4\">Forms with FastAPI and Jinja</h1>\n    <div
  ...
  partial: "<article class='w-full'>\n    <div class=\"mt-8 mb-8 -mx-8\">\n        <img
    src=\"/media/forms-with-fast-api-and-jinja.png\" alt=\"Forms with FastAPI and
    Jinja cover image\" class=\"w-full object-cover rounded-lg shadow-2xl border-4
    ...
    lg:prose-xl max-w-none mx-auto mt-8\">\n        <p>I just started using FastAPI
    for a home project and needed to pass back a\ndynamic number of values from a
    form rendered with jinja...</p>\n<h1 id=\"dynamic-values\">Dynamic Values <a class=\"header-anchor\"
