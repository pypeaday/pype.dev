...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Forms with FastAPI
    ...
    lg:prose-xl mx-auto mt-8\">\n        <p>I just started using FastAPI for a home
    project and needed to pass back a\ndynamic number of values from a form rendered
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n    <div class=\"mt-8 mb-8
    md:-mx-4\">\n        <img src=\"/media/forms-with-fast-api-and-jinja.png\" alt=\"Forms
    with FastAPI and Jinja cover image\" class=\"w-full object-cover rounded-lg shadow-2xl
