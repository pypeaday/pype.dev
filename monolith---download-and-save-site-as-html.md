...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Monolith - download
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    gradient-text mb-4 post-title-large\">Monolith - download and save site as html</h1>\n
    ...
    \       <h2 id=\"til-monolith\">TIL: Monolith <a class=\"header-anchor\" href=\"#til-monolith\"><svg
