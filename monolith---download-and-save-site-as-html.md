...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Monolith - download
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Monolith
    - download and save site as html</h1>\n    <div class=\"flex items-center text-sm
    ...
    lg:prose-xl mx-auto mt-8\">\n        <h2 id=\"til-monolith\">TIL: Monolith <a
    class=\"header-anchor\" href=\"#til-monolith\"><svg class=\"heading-permalink\"
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Monolith - download
    ...
    font-bold text-text-heading mb-4\">Monolith - download and save site as html</h1>\n
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Monolith - download and save site as html</h1>\n    <div class=\"flex items-center
