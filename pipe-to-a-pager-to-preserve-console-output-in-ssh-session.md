...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Pipe to a pager
    ...
    lg:prose-xl mx-auto mt-8\">\n        <p>I'm playing with my ansible playbook in
    a remote tmux session, and I'm no wiz\nso I don't know the ins and outs, but I
    can't scroll up to get any console log\noutput that's not already visible on my
    screen. So I'm starting to end my\ncommands with <code> | less</code> so I can
    page through the console output!</p>\n<p><code>ansible-playbook plays.yml -v --tags
    mytag | less</code></p>\n\n    </section>\n</article>        </div>\n    </main>\n\n</div>\n
    \    </body>\n</html>"
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Pipe to a pager to preserve console output in SSH session</h1>\n    <div
