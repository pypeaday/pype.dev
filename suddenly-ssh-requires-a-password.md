---
content: 'ssh -v -i ~/.ssh/id_rsa nic@hogwarts


  THen we can look at print outs


  cat /var/log/auth.log  also showed me that I had too wide permissions on files in
  ~/.ssh -> probably changed from an rsync job'
date: 2022-10-07
description: ssh -v -i ~/.ssh/id_rsa nic@hogwarts THen we can look at print outs cat
  /var/log/auth.log  also showed me that I had too wide permissions on files in ~/.ssh
  -&g
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Suddenly SSH requires
    a password</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width,
    initial-scale=1\" />\n<meta name=\"description\" content=\"ssh -v -i ~/.ssh/id_rsa
    nic@hogwarts THen we can look at print outs cat /var/log/auth.log  also showed
    me that I had too wide permissions on files in ~/.ssh -&g\" />\n <link href=\"/favicon.ico\"
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Suddenly
    SSH requires a password</h1>\n    <div class=\"flex items-center text-sm text-text-main/80
    ...
    at print outs</p>\n<p>cat /var/log/auth.log  also showed me that I had too wide
    permissions on files in ~/.ssh -&gt; probably changed from an rsync job</p>\n\n
    \   </section>\n</article>        </div>\n    </main>\n\n</div>\n     </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Suddenly SSH requires
    a password</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width,
    initial-scale=1\" />\n<meta name=\"description\" content=\"ssh -v -i ~/.ssh/id_rsa
    ...
    font-bold text-text-heading mb-4\">Suddenly SSH requires a password</h1>\n    <div
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Suddenly SSH requires a password</h1>\n    <div class=\"flex items-center
    ...
    we can look at print outs</p>\n<p>cat /var/log/auth.log  also showed me that I
    had too wide permissions on files in ~/.ssh -&gt; probably changed from an rsync
    job</p>\n\n    </section>\n</article>"
  raw.md: "---\ndate: 2022-10-07 11:14:37\ntemplateKey: til\ntitle: Suddenly SSH requires
    a password\npublished: False\ntags:\n  - linux\n  - cli\n  - tech\n  - til\n\n---\n\n\nssh
    -v -i ~/.ssh/id_rsa nic@hogwarts\n\nTHen we can look at print outs\n\ncat /var/log/auth.log
    \ also showed me that I had too wide permissions on files in ~/.ssh -> probably
    changed from an rsync job\n"
published: false
slug: suddenly-ssh-requires-a-password
