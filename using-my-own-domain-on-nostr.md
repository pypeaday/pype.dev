...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Using my own domain
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Using
    my own domain on nostr</h1>\n    <div class=\"flex items-center text-sm text-text-main/80
    ...
    mt-8\">\n        <p>After generating a keypair on a nostr app (I started with
    primal) I copied my\npublic key to <code>/.well-known/nostr.json</code> and put
    that at the root of my site at\n<code>https://pype.dev</code>.</p>\n<p>The file
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Using my own domain
    ...
    font-bold text-text-heading mb-4\">Using my own domain on nostr</h1>\n    <div
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Using my own domain on nostr</h1>\n    <div class=\"flex items-center text-sm
