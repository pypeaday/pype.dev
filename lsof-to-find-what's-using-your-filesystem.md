...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>lsof to find what's
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">lsof
    to find what's using your filesystem</h1>\n    <div class=\"flex items-center
    ...
    lg:prose-xl mx-auto mt-8\">\n        <p>lsof | grep /tank/nas shows me what is
    using my nas at any time!</p>\n\n    </section>\n</article>        </div>\n    </main>\n\n</div>\n
    \    </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>lsof to find what's
    using your filesystem</title>\n<meta charset=\"UTF-8\" />\n<meta name=\"viewport\"
    content=\"width=device-width, initial-scale=1\" />\n<meta name=\"description\"
    ...
    font-bold text-text-heading mb-4\">lsof to find what's using your filesystem</h1>\n
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">lsof to find what's using your filesystem</h1>\n    <div class=\"flex items-center
    text-sm text-text-main/80 mb-6\">\n        <time datetime=\"2023-04-09\">\n            April
    09, 2023\n        </time>\n    </div>\n    <div class=\"flex flex-wrap gap-2\">\n
    \           <a href=\"https://pype.dev//tags/zfs/\" class=\"inline-block bg-primary-light
    text-accent-cool text-xs font-medium px-3 py-1 rounded-full hover:bg-primary-light/80
