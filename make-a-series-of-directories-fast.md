...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Make a series of
    ...
    a series of directories fast! | Nic Payne\" />\n<meta property=\"og:description\"
    content=\"mkdir s{1..10} will make directories s1, s2, ... s10 in one command!\"
    />\n<meta property=\"og:image\" content=\"https://cdn.statically.io/gh/pypeaday/pype.dev/main/pages/media/og-02.png\"
    />\n<meta property=\"og:url\" content=\"https://pype.devmake-a-series-of-directories-fast\"
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    mt-8\">\n        <p>mkdir s{1..10} will make directories s1, s2, ... s10 in one
    command!</p>\n\n    </section>\n</article>        </div>\n    </main>\n\n</div>\n
    \    </body>\n</html>"
