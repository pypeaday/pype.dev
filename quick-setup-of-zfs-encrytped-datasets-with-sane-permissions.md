...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Quick setup of ZFS
    ...
    md:text-5xl font-bold text-text-heading mb-4\">Quick setup of ZFS encrytped datasets
    with sane permissions</h1>\n    <div class=\"flex items-center text-sm text-text-main/80
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Quick setup of ZFS
    ...
    font-bold text-text-heading mb-4\">Quick setup of ZFS encrytped datasets with
    sane permissions</h1>\n    <div class=\"flex items-center text-sm text-text-main/80
    mb-6\">\n        <time datetime=\"2022-10-06\">\n            October 06, 2022\n
    \       </time>\n    </div>\n    <div class=\"flex flex-wrap gap-2\">\n            <a
    href=\"https://pype.dev//tags/zfs/\" class=\"inline-block bg-primary-light text-accent-cool
  ...
  partial: "<article class='w-full'>\n<section class=\"post-header mb-8\">\n    <h1
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Quick
    setup of ZFS encrytped datasets with sane permissions</h1>\n    <div class=\"flex
