...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Reindex Nextcloud
    ...
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Reindex
    Nextcloud After Adding Data via CLI</h1>\n    <div class=\"flex items-center text-sm
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Reindex Nextcloud After
    ...
    font-bold text-text-heading mb-4\">Reindex Nextcloud After Adding Data via CLI</h1>\n
  ...
  partial: "<article class='w-full overflow-x-hidden'>\n<section class=\"post-header
    ...
    mb-4\">Reindex Nextcloud After Adding Data via CLI</h1>\n    <div class=\"flex
