...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Plotly-And-Streamlit</title>\n<meta
    ...
    class='w-full'>\n    <div class=\"mt-8 mb-8 -mx-8\">\n        <img src=\"/media/plotly-and-streamlit.png\"
    alt=\"Plotly-And-Streamlit cover image\" class=\"w-full object-cover rounded-lg
    shadow-2xl border-4 border-white dark:border-gray-600\" style=\"max-height: 400px;\">\n
    \   </div>\n<section class=\"post-header mb-8\">\n    <h1 id=\"title\" class=\"text-4xl
    md:text-5xl font-bold text-text-heading mb-4\">Plotly-And-Streamlit</h1>\n    <div
