...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Interesting IPs
    ...
    md:text-5xl font-bold text-text-heading mb-4\">Interesting IPs between Jellyfin
    clients and server depending on tailscale and server address</h1>\n    <div class=\"flex
    ...
    lg:prose-xl max-w-none mx-auto mt-8\">\n        <p>When connecting from my phone
    to jellyfin I'm seeing some interesting patterns.</p>\n<h2 id=\"scenarios\">Scenarios
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Interesting IPs between
    ...
    font-bold text-text-heading mb-4\">Interesting IPs between Jellyfin clients and
    server depending on tailscale and server address</h1>\n    <div class=\"flex items-center
  ...
  partial: "<article class='w-full'>\n<section class=\"post-header mb-8\">\n    <h1
    id=\"title\" class=\"text-4xl md:text-5xl font-bold text-text-heading mb-4\">Interesting
    IPs between Jellyfin clients and server depending on tailscale and server address</h1>\n
