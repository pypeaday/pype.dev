...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Use the right lspsage,
    ...
    md:text-5xl font-bold text-text-heading mb-4\">Use the right lspsage, you dope!</h1>\n
  ...
  partial: "<article class='w-full'>\n<section class=\"post-header mb-8\">\n    <h1
    ...
    lg:prose-xl max-w-none mx-auto mt-8\">\n        <p>If you think glepnir/lspsaga.nvim
    config will work with tali5/lspsaga.nvim installed... you're in for a rude awakening.
