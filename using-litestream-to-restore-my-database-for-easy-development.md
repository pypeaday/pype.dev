...
content: "# Litestream\n\nsee [[using-litestream-to-backup-quadtasks-sqlite-db]] for
  ...
  \ replicas:\n  - name: quadtask\n    type: s3\n    bucket: litestream\n    path:
  quadtask-${ENVIRONMENT}\n    endpoint: s3.example.com\n    skip-verify: false\n
  \   region: us-east-1\n```\n\nAnd so wherever I spin up quadtask: local, dev, or
  prod - the replication will\nhappen to and from a different path in my litestream
  bucket!"
date: 2025-08-07
...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Using Litestream
    ...
    Litestream to Restore My Database for Easy Development | Nic Payne\" />\n<meta
    property=\"og:image\" content=\"https://cdn.statically.io/gh/pypeaday/images.pype.dev/main/blog-media/20250807213014_2a14556e.png\"
    ...
    */\n    @media (max-width: 480px) {\n        .boundary-break-container {\n            height:
    ...
    \       <div class=\"boundary-break-glow\"></div>\n        <img \n            src=\"https://cdn.statically.io/gh/pypeaday/images.pype.dev/main/blog-media/20250807213014_2a14556e.png\"
    \n            alt=\"Using Litestream to Restore My Database for Easy Development
    ...
    Litestream to Restore My Database for Easy Development</h1>\n    <div class=\"flex
    ...
    \       <h1 id=\"litestream\">Litestream <a class=\"header-anchor\" href=\"#litestream\"><svg
    ...
    database found, restoring from replica if exists&quot;</span>\n<span class=\"w\">\t</span>litestream<span
    class=\"w\"> </span>restore<span class=\"w\"> </span>-v<span class=\"w\"> </span>/app/data/quadtask.db\n<span
    class=\"k\">fi</span>\n<span class=\"c1\"># Run litestream with your app as the
    subprocess.</span>\n<span class=\"nb\">exec</span><span class=\"w\"> </span>litestream<span
    class=\"w\"> </span>replicate<span class=\"w\"> </span>-exec<span class=\"w\">
    </span><span class=\"s2\">&quot;uvicorn app.main:app --host 0.0.0.0 --port 8000
    --reload --log-level debug&quot;</span>\n</pre></div>\n\n</pre>\n\n<h2 id=\"appropriate-and-safe-replication\">Appropriate
    and Safe Replication <a class=\"header-anchor\" href=\"#appropriate-and-safe-replication\"><svg
    class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
    height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span><span class=\"nt\">dbs</span><span
    class=\"p\">:</span>\n<span class=\"p p-Indicator\">-</span><span class=\"w\">
    </span><span class=\"nt\">path</span><span class=\"p\">:</span><span class=\"w\">
    </span><span class=\"l l-Scalar l-Scalar-Plain\">/app/data/quadtask.db</span>\n<span
    class=\"w\">  </span><span class=\"nt\">replicas</span><span class=\"p\">:</span>\n<span
    class=\"w\">  </span><span class=\"p p-Indicator\">-</span><span class=\"w\">
    </span><span class=\"nt\">name</span><span class=\"p\">:</span><span class=\"w\">
  ...
  raw.md: "---\ndate: 2025-08-07 15:14:45\ntemplateKey: blog-post\ntitle: Using Litestream
    ...
    \ replicas:\n  - name: quadtask\n    type: s3\n    bucket: litestream\n    path:
    quadtask-${ENVIRONMENT}\n    endpoint: s3.example.com\n    skip-verify: false\n
    \   region: us-east-1\n```\n\nAnd so wherever I spin up quadtask: local, dev,
    or prod - the replication will\nhappen to and from a different path in my litestream
    bucket!\n\n"
published: true
