---
content: "Sometimes I need to manually set a static IP of a Linux machine. I generally
  run the latest version of Ubuntu server in my VMs at home.\n\nIn Ubuntu 20 I'm able
  to change up `/etc/netplan/<something>.yml`\n\n```yaml\nnetwork:\n  version: 2\n
  \ ethernets:\n    enp0s4:\n      addresses: [192.168.1.{Static IP}/24]\n      gateway4:
  192.168.1.1\n      nameservers:\n        addresses: [192.168.1.1, 1.1.1.1]\n```\n\n`gateway4`
  is your router address\n`nameservers` is a list of desired DNS servers for that
  machine to use. I  usually use my router which is configured to use my pi-hole as
  my primary DNS, then set  `1.1.1.1` (CloudFlare) as a backup\n\nHit it with the
  `sudo netplan apply` and you should be good to go!"
date: 2022-03-03
description: Sometimes I need to manually set a static IP of a Linux machine. I generally
  run the latest version of Ubuntu server in my VMs at home. In Ubuntu 20 I&#x27;m
  ab
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n    <head>\n<title>Ubuntu-Static-Ip</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"Sometimes I need to manually set a static
    IP of a Linux machine. I generally run the latest version of Ubuntu server in
    my VMs at home. In Ubuntu 20 I&#x27;m ab\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
    ...
    class='w-full'>\n    <div class=\"mt-8 mb-8 -mx-8\">\n        <img src=\"/media/ubuntu-static-ip.png\"
    alt=\"Ubuntu-Static-Ip cover image\" class=\"w-full object-cover rounded-lg shadow-2xl
    border-4 border-white dark:border-gray-600\" style=\"max-height: 400px;\">\n    </div>\n<section
    class=\"post-header mb-8\">\n    <h1 id=\"title\" class=\"text-4xl md:text-5xl
    font-bold text-text-heading mb-4\">Ubuntu-Static-Ip</h1>\n    <div class=\"flex
    ...
    lg:prose-xl max-w-none mx-auto mt-8\">\n        <p>Sometimes I need to manually
    set a static IP of a Linux machine. I generally run the latest version of Ubuntu
    server in my VMs at home.</p>\n<p>In Ubuntu 20 I'm able to change up <code>/etc/netplan/&lt;something&gt;.yml</code></p>\n<pre
  ...
  partial: "<article class='w-full'>\n    <div class=\"mt-8 mb-8 -mx-8\">\n        <img
    src=\"/media/ubuntu-static-ip.png\" alt=\"Ubuntu-Static-Ip cover image\" class=\"w-full
    ...
    mx-auto mt-8\">\n        <p>Sometimes I need to manually set a static IP of a
    Linux machine. I generally run the latest version of Ubuntu server in my VMs at
    home.</p>\n<p>In Ubuntu 20 I'm able to change up <code>/etc/netplan/&lt;something&gt;.yml</code></p>\n<pre
    class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button class='copy' title='copy
    code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
    version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  ...
  raw.md: "---\ntemplateKey: til\ntags: ['linux', 'til']\ntitle: Ubuntu-Static-Ip\ndate:
    ...
    I need to manually set a static IP of a Linux machine. I generally run the latest
    version of Ubuntu server in my VMs at home.\n\nIn Ubuntu 20 I'm able to change
    up `/etc/netplan/<something>.yml`\n\n```yaml\nnetwork:\n  version: 2\n  ethernets:\n
    \   enp0s4:\n      addresses: [192.168.1.{Static IP}/24]\n      gateway4: 192.168.1.1\n
    \     nameservers:\n        addresses: [192.168.1.1, 1.1.1.1]\n```\n\n`gateway4`
    is your router address\n`nameservers` is a list of desired DNS servers for that
    machine to use. I  usually use my router which is configured to use my pi-hole
    as my primary DNS, then set  `1.1.1.1` (CloudFlare) as a backup\n\nHit it with
    the `sudo netplan apply` and you should be good to go!\n"
published: true
